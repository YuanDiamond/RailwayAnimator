...
var l = o((e => {
    ...
    function oe(e, r, i, a, o) {
      ...
      if (c) return o = o(e), c = a === `` ? `.` + E(e, 0) : a, S(o) ? (i = ``, c != null && (i = c.replace(ie, `$&/`) + `/`), oe(o, r, i, ``, function(e) {
        return e
      })) : o != null && (re(o) && (o = ne(o, i + (o.key == null || e && e.key === o.key ? `` : (`` + o.key).replace(ie, `$&/`) + `/`) + c)), r.push(o)), 1;
      c = 0;
      var l = a === `` ? `.` : a + `:`;
      if (S(e))
        for (var u = 0; u < e.length; u++) a = e[u], s = l + E(a, u), c += oe(a, r, i, s, o);
      else if (u = m(e), typeof u == `function`)
        for (e = u.call(e), u = 0; !(a = e.next()).done;) a = a.value, s = l + E(a, u++), c += oe(a, r, i, s, o);
      else if (s === `object`) {
    ...
    e.Activity = f, e.Children = O, e.Component = v, e.Fragment = r, e.Profiler = a, e.PureComponent = b, e.StrictMode = i, e.Suspense = l, e.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = w, e.__COMPILER_RUNTIME = {
      ...
      var r = g({}, e.props),
        i = e.key;
      if (t != null)
        for (a in t.key !== void 0 && (i = `` + t.key), t) !ee.call(t, a) || a === `key` || a === `__self` || a === `__source` || a === `ref` && t.ref === void 0 || (r[a] = t[a]);
      ...
      var r, i = {},
        a = null;
      if (t != null)
        for (r in t.key !== void 0 && (a = `` + t.key), t) ee.call(t, r) && r !== `key` && r !== `__self` && r !== `__source` && (i[r] = t[r]);
  ...
  d = o((e => {
    ...
    if (typeof y == `function`) re = function() {
      ...
      var T = new MessageChannel,
        ie = T.port2;
      T.port1.onmessage = ne, re = function() {
        ie.postMessage(null)
      }
    } else re = function() {
      _(ne, 0)
    ...
    e.unstable_IdlePriority = 5, e.unstable_ImmediatePriority = 1, e.unstable_LowPriority = 4, e.unstable_NormalPriority = 3, e.unstable_Profiling = null, e.unstable_UserBlockingPriority = 2, e.unstable_cancelCallback = function(e) {
      ...
      return s = a + s, r = {
        ...
        expirationTime: s,
        sortIndex: -1
      }, a > o ? (r.sortIndex = a, t(l, r), n(c) === null && r === n(l) && (h ? (v(C), C = -1) : h = !0, E(x, a - o))) : (r.sortIndex = s, t(c, r), m || p || (m = !0, S || (S = !0, re()))), r
  ...
  h = o((e => {
    ...
    function de(e) {
      0 > ue || (e.current = k[ue], k[ue] = null, ue--)
    }

    function j(e, t) {
      ue++, k[ue] = e.current, e.current = t
    }
    var fe = A(null),
      pe = A(null),
      me = A(null),
    ...
    function ye(e) {
      pe.current === e && (de(fe), de(pe)), he.current === e && (de(he), Qf._currentValue = le)
    }
    var be, xe;
...
` + e.stack
    ...
    var At = RegExp(`^[:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD][:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*$`),
      jt = {},
      Mt = {};
    ...
    function pn(e, t, n) {
      ...
      try {
        ...
        if (fn = !1, (ln !== null || un !== null) && (bu(), ln && (t = ln, e = un, un = ln = null, dn(t), e)))
    ...
    function Gr(e) {
      ...
      var t = Hr[e],
        n;
      for (n in t)
        if (t.hasOwnProperty(n) && n in Wr) return Ur[e] = t[n];
      return e
    }
    ...
    function vi(e, t, n, r, a, o) {
      ...
      if (r = e, typeof e == `function`) hi(e) && (s = 1);
        ...
        case T:
          return e = mi(31, n, t, a), e.elementType = T, e.lanes = o, e;
        case y:
    ...
    function Fi(e, t, n) {
      ...
      if (30 < a) {
        var o = i - i % 5;
        a = (r & (1 << o) - 1).toString(32), r >>= o, i -= o, Mi = 1 << 32 - Ue(t) + i | n << i | r, Ni = a + e
    ...
    function $i(e, t, n) {
      j(Xi, t._currentValue), t._currentValue = n
    }

    function ea(e) {
      e._currentValue = Xi.current, de(Xi)
    }
    ...
    var xa = D.S;
    D.S = function(e, t) {
      eu = M(), typeof t == `object` && t && typeof t.then == `function` && va(e, t), xa !== null && xa(e, t)
    };
    var Sa = A(null);
    ...
    function Va(e) {
      ...
      function l(e, t, n, r) {
        var i = n.type;
        return i === y ? d(e, t, n.props.children, r, n.key) : t !== null && (t.elementType === i || typeof i == `object` && i && i.$$typeof === re && Ma(i) === t.type) ? (t = a(t, n.props), za(t, n), t.return = e, t) : (t = vi(n.type, n.key, n.props, null, e.mode, r), za(t, n), t.return = e, t)
      }
    ...
    function io(e, t) {
      e = Wl, j(ro, e), j(no, t), Wl = e | t.baseLanes
    }

    function ao() {
      j(ro, Wl), j(no, no.current)
    }

    function oo() {
      Wl = ro.current, de(no), de(ro)
    }
    var so = A(null),
      co = null;
    ...
    function Io(e) {
      ...
      if (t ??= {
          data: [],
          index: 0
        }, n === null && (n = No(), L.updateQueue = n), n.memoCache = t, n = t.data[t.index], n === void 0)
    ...
    function Vo(e, t, n) {
      ...
      if (s && (a.memoizedState = n, H = !0), a = a.queue, fs(Wo.bind(null, r, a, e), [e]), a.getSnapshot !== t || s || z !== null && z.memoizedState.tag & 1) {
        if (r.flags |= 2048, ss(9, {
            destroy: void 0
          }, Uo.bind(null, r, a, n, t), null), K === null) throw Error(i(349));
        o || go & 127 || Ho(r, t, n)
      }
      return n
    }
    ...
    function $o(e, t, n) {
      ...
      if (e.pending = null, r !== null) {
        r = r.next;
        do t.status = `rejected`, t.reason = n, es(t), t = t.next; while (t !== r)
      }
      e.action = null
    }
    ...
    function ns(e, t) {
      ...
      return n = Mo(), n.memoizedState = n.baseState = t, r = {
        ...
        action: e,
        pending: null
      }, r.queue = i, n = Yo.bind(null, L, i, a, n), i.dispatch = n, r.memoizedState = e, [t, n, !1]
    }
    ...
    function is(e, t, n) {
      ...
      var i = t.queue,
        a = i.dispatch;
      return n !== t.memoizedState && (L.flags |= 2048, ss(9, {
        destroy: void 0
      }, as.bind(null, i, n), null)), [r, a, e]
    }
    ...
    function ls(e, t, n, r) {
      var i = Mo();
      L.flags |= e, i.memoizedState = ss(1 | t, {
        destroy: void 0
      }, n, r === void 0 ? null : r)
    }
    ...
    var Vs = {
        ...
        useSyncExternalStore: function(e, t, n) {
          ...
          return a.queue = o, ds(Wo.bind(null, r, o, e), [e]), r.flags |= 2048, ss(9, {
            destroy: void 0
          }, Uo.bind(null, r, o, n, t), null), n
        },
        useId: function() {
          var e = Mo(),
    ...
    function rc(e, t, n, r, a) {
      if (n.flags |= 32768, typeof r == `object` && r && typeof r.then == `function`) {
        if (t = n.alternate, t !== null && ra(t, n, a, !0), n = so.current, n !== null) {
          switch (n.tag) {
            case 31:
            case 13:
              return co === null ? Du() : n.alternate === null && X === 0 && (X = 3), n.flags &= -257, n.flags |= 65536, n.lanes = a, r === ka ? n.flags |= 16384 : (t = n.updateQueue, t === null ? n.updateQueue = new Set([r]) : t.add(r), Gu(e, r, a)), !1;
            case 22:
              return n.flags |= 65536, r === ka ? n.flags |= 16384 : (t = n.updateQueue, t === null ? (t = {
                transitions: null,
      ...
      if (P) return t = so.current, t === null ? (r !== Hi && (t = Error(i(423), {
        cause: r
      }), Yi(wi(t, n))), e = e.current.alternate, e.flags |= 65536, a &= -a, e.lanes |= a, r = wi(r, n), a = ec(e.stateNode, r, a), Xa(e, a), X !== 4 && (X = 2)) : (!(t.flags & 65536) && (t.flags |= 256), t.flags |= 65536, t.lanes = a, r !== Hi && (e = Error(i(422), {
        cause: r
      }), Yi(wi(e, n)))), !1;
      var o = Error(i(520), {
        cause: r
      ...
      do {
        switch (n.tag) {
          case 3:
            return n.flags |= 65536, e = a & -a, n.lanes |= e, e = ec(n.stateNode, r, e), Xa(n, e), !1;
          case 1:
            if (t = n.type, o = n.stateNode, !(n.flags & 128) && (typeof t.getDerivedStateFromError == `function` || o !== null && typeof o.componentDidCatch == `function` && (ru === null || !ru.has(o)))) return n.flags |= 65536, a &= -a, n.lanes |= a, a = tc(a), nc(a, e, n, r), Xa(n, a), !1
        }
        n = n.return
      } while (n !== null);
      return !1
    ...
    function mc(e, t, n) {
      ...
      if (o !== null) {
        ...
        if (uo(t), a)
          ...
          if (r = K, r !== null && (s = ot(r, n), s !== 0 && s !== o.retryLane)) throw o.retryLane = s, li(e, s), hu(r, e, s), ic;
          Du(), t = pc(e, t, n)
    ...
    function Cc(e, t, n) {
      ...
      if (l !== null && (c = l.dehydrated, c !== null)) {
        if (o) t.flags & 256 ? (lo(t), t.flags &= -257, t = Ec(e, t, n)) : t.memoizedState === null ? (po(t), c = r.fallback, a = t.mode, r = Tc({
          ...
          if (s = K, s !== null && (r = ot(s, n), r !== 0 && r !== l.retryLane)) throw l.retryLane = r, li(e, r), hu(s, e, r), ic;
          af(c) || Du(), t = Ec(e, t, n)
    ...
    function kc(e, t, n) {
      ...
      var o = I.current,
        s = (o & 2) != 0;
      if (s ? (o = o & 1 | 2, t.flags |= 128) : o &= 1, j(I, o), ac(e, t, r, n), r = P ? Oi : 0, !s && e !== null && e.flags & 128) a: for (e = t.child; e !== null;) {
    ...
    function Mc(e, t, n) {
      switch (t.tag) {
        case 3:
          ge(t, t.stateNode.containerInfo), $i(t, F, e.memoizedState.cache), qi();
          break;
        case 27:
        case 5:
          ve(t);
    ...
    function Nc(e, t, n) {
      ...
      switch (t.lanes = 0, t.tag) {
        ...
        case 3:
          a: {
            if (ge(t, t.stateNode.containerInfo), e === null) throw Error(i(387));r = t.pendingProps;
          ...
          return t;
        case 26:
          return hc(e, t), e === null ? (n = kf(t.type, null, t.pendingProps, null)) ? t.memoizedState = n : P || (n = t.type, e = t.pendingProps, r = Bd(me.current).createElement(n), r[ft] = t, r[pt] = e, Pd(r, n, e), Tt(r), t.stateNode = r) : t.memoizedState = kf(t.type, e.memoizedProps, t.pendingProps, e.memoizedState), null;
        case 27:
          return ve(t), e === null && P && (r = t.stateNode = ff(t.type, t.pendingProps, me.current), zi = t, Vi = !0, a = N, Zd(t.type) ? (lf = a, N = cf(r.firstChild)) : N = a), ac(e, t, t.pendingProps.children, n), hc(e, t), e === null && (t.flags |= 4194304), t.child;
        case 5:
          return e === null && P && ((a = r = N) && (r = tf(r, t.type, t.pendingProps, Vi), r === null ? a = !1 : (t.stateNode = r, zi = t, N = cf(r.firstChild), Vi = !1, a = !0)), a || Ui(t)), ve(t), a = t.type, o = t.pendingProps, s = e === null ? null : e.memoizedProps, r = o.children, Ud(a, o) ? r = null : s !== null && Ud(a, s) && (t.flags |= 32), t.memoizedState !== null && (a = To(e, t, Oo, null, null, n), Qf._currentValue = a), hc(e, t), ac(e, t, r, n), t.child;
        case 6:
          return e === null && P && ((e = n = N) && (n = nf(n, t.pendingProps, Vi), n === null ? e = !1 : (t.stateNode = n, zi = t, N = null, e = !0)), e || Ui(t)), null;
        case 13:
          return Cc(e, t, n);
        case 4:
          return ge(t, t.stateNode.containerInfo), r = t.pendingProps, e === null ? t.child = Ha(t, null, r, n) : ac(e, t, r, n), t.child;
        case 11:
        ...
        case 9:
          return a = t.type._context, r = t.pendingProps.children, aa(t), a = oa(a), r = r(a), t.flags |= 1, ac(e, t, r, n), t.child;
        case 14:
        ...
        case 24:
          return aa(t), r = oa(F), e === null ? (a = Ca(), a === null && (a = K, o = fa(), a.pooledCache = o, o.refCount++, o !== null && (a.pooledCacheLanes |= n), a = o), t.memoizedState = {
            parent: r,
            cache: a
    ...
    function zc(e, t, n) {
      ...
      switch (Li(t), t.tag) {
        ...
        case 1:
          return U(t), null;
        case 3:
          return n = t.stateNode, r = null, e !== null && (r = e.memoizedState.cache), t.memoizedState.cache !== r && (t.flags |= 2048), ea(F), _e(), n.pendingContext && (n.context = n.pendingContext, n.pendingContext = null), (e === null || e.child === null) && (Ki(t) ? Pc(t) : e === null || e.memoizedState.isDehydrated && !(t.flags & 256) || (t.flags |= 1024, Ji())), U(t), null;
        case 26:
          var a = t.type,
            o = t.memoizedState;
        ...
        case 27:
          if (ye(t), n = me.current, a = t.type, e !== null && t.stateNode != null) e.memoizedProps !== r && Pc(t);
            ...
            e = fe.current, Ki(t) ? Wi(t, e) : (e = ff(a, r, n), t.stateNode = e, Pc(t))
          }
          return U(t), null;
        case 5:
        ...
        case 4:
          return _e(), e === null && Sd(t.stateNode.containerInfo), U(t), null;
        case 10:
          return ea(t.type), U(t), null;
        case 19:
          if (de(I), r = t.memoizedState, r === null) return U(t), null;
              ...
              if (X !== 0 || e !== null && e.flags & 128)
                for (e = t.child; e !== null;) {
                  if (o = ho(e), o !== null) {
                    ...
                    return j(I, I.current & 1 | 2), P && Pi(t, r.treeForkCount), t.child
                  }
                  e = e.sibling
                }
              r.tail !== null && M() > tu && (t.flags |= 128, a = !0, Rc(r, !1), t.lanes = 4194304)
            }
          else {
            if (!a)
              if (e = ho(o), e !== null) {
              ...
              } else 2 * M() - r.renderingStartTime > tu && n !== 536870912 && (t.flags |= 128, a = !0, Rc(r, !1), t.lanes = 4194304);
            r.isBackwards ? (o.sibling = t.child, t.child = o) : (e = r.last, e === null ? t.child = o : e.sibling = o, r.last = o)
          }
          return r.tail === null ? (U(t), null) : (e = r.tail, r.rendering = e, r.tail = e.sibling, r.renderingStartTime = M(), e.sibling = null, n = I.current, j(I, a ? n & 1 | 2 : n & 1), P && Pi(t, r.treeForkCount), e);
        case 22:
        case 23:
          return mo(t), oo(), r = t.memoizedState !== null, e === null ? r && (t.flags |= 8192) : e.memoizedState !== null !== r && (t.flags |= 8192), r ? n & 536870912 && !(t.flags & 128) && (U(t), t.subtreeFlags & 6 && (t.flags |= 8192)) : U(t), n = t.updateQueue, n !== null && Lc(t, n.retryQueue), n = null, e !== null && e.memoizedState !== null && e.memoizedState.cachePool !== null && (n = e.memoizedState.cachePool.pool), r = null, t.memoizedState !== null && t.memoizedState.cachePool !== null && (r = t.memoizedState.cachePool.pool), r !== n && (t.flags |= 2048), e !== null && de(Sa), null;
        case 24:
          return n = null, e !== null && (n = e.memoizedState.cache), t.memoizedState.cache !== n && (t.flags |= 2048), ea(F), U(t), null;
        case 25:
          return null;
        case 30:
          return null
    ...
    function Bc(e, t) {
      switch (Li(t), t.tag) {
        ...
        case 3:
          return ea(F), _e(), e = t.flags, e & 65536 && !(e & 128) ? (t.flags = e & -65537 | 128, t) : null;
        case 26:
        case 27:
        case 5:
          return ye(t), null;
        ...
        case 22:
        case 23:
          return mo(t), oo(), e !== null && de(Sa), e = t.flags, e & 65536 ? (t.flags = e & -65537 | 128, t) : null;
        case 24:
          return ea(F), null;
        case 25:
          return null;
    ...
    function vl(e, t) {
      ...
      switch (e.tag) {
        ...
        case 31:
          ...
          break;
        case 13:
          gl(t, e), yl(e), e.child.flags & 8192 && e.memoizedState !== null != (n !== null && n.memoizedState !== null) && ($l = M()), r & 4 && (r = e.updateQueue, r !== null && (e.updateQueue = null, hl(e, r)));
          break;
        case 22:
      ...
      do {
        if (a === 0) {
          ...
          a: {
            ...
            if ((t & 62914560) === t && (a = $l + 300 - M(), 10 < a)) {
    ...
    function _u(e, t, n, r, i, a, o, s, c, l, u, d, f, p) {
      if (e.timeoutHandle = -1, d = t.subtreeFlags, d & 8192 || (d & 16785408) == 16785408) {
        ...
        var m = (a & 62914560) === a ? $l - M() : (a & 4194048) === a ? eu - M() : 0;
        if (m = qf(d, m), m !== null) {
    ...
    function Su(e, t) {
      ...
      n !== -1 && (e.timeoutHandle = -1, qd(n)), n = e.cancelPendingCommit, n !== null && (e.cancelPendingCommit = null, n()), su = 0, xu(), K = e, q = n = gi(e.current, null), J = t, Y = 0, Bl = null, Vl = !1, Hl = Qe(e, t), Ul = !1, Yl = Jl = ql = Kl = Gl = X = 0, Zl = Xl = null, Ql = !1, t & 8 && (t |= t & 32);
    ...
    function Au(e, t) {
      ...
      var r = Tu(),
        a = Eu();
      K !== e || J !== t ? (nu = null, tu = M() + 500, Su(e, t)) : Hl = Qe(e, t);
      a: do try {
          if (Y !== 0 && q !== null) {
            t = q;
            var o = Bl;
    ...
    function Lu(e, t, n, r, a, o, s, c, l) {
      ...
      if (t !== null) {
        ...
        if (o = t.lanes | t.childLanes, o |= ai, rt(e, n, o, s, c, l), e === K && (q = K = null, J = 0), ou = t, au = e, su = n, cu = o, lu = a, uu = r, t.subtreeFlags & 10256 || t.flags & 10256 ? (e.callbackNode = null, e.callbackPriority = 0, Xu(Fe, function() {
            return Uu(), null
    ...
    function Wu(e, t, n) {
      t = wi(n, t), t = ec(e.stateNode, t, 2), e = Ja(e, t, 2), e !== null && (nt(e, 2), rd(e))
    }
        ...
        for (; t !== null;) {
          if (t.tag === 3) {
            ...
            if (typeof t.type.getDerivedStateFromError == `function` || typeof r.componentDidCatch == `function` && (ru === null || !ru.has(r))) {
              e = wi(n, e), n = tc(2), r = Ja(t, n, 2), r !== null && (nc(n, r, t, e), nt(r, 2), rd(r));
              break
            }
          }
          t = t.return
    ...
    function Ku(e, t, n) {
      var r = e.pingCache;
      r !== null && r.delete(t), e.pingedLanes |= e.suspendedLanes & n, e.warmLanes &= ~n, K === e && (J & n) === n && (X === 4 || X === 3 && (J & 62914560) === J && 300 > M() - $l ? !(G & 2) && Su(e, 0) : ql |= n, Yl === J && (Yl = 0)), rd(e)
    }

    function qu(e, t) {
      t === 0 && (t = et()), e = li(e, t), e !== null && (nt(e, t), rd(e))
    }
    ...
    function od() {
      ...
      var e = 0;
      nd !== 0 && Gd() && (e = nd);
      for (var t = M(), n = null, r = Zu; r !== null;) {
        var i = r.next,
          a = sd(r, t);
    ...
    function sd(e, t) {
      ...
      if (t = K, n = J, n = Ze(e, e === t ? n : 0, e.cancelPendingCommit !== null || e.timeoutHandle !== -1), r = e.callbackNode, n === 0 || e === t && (Y === 2 || Y === 9) || e.cancelPendingCommit !== null) return r !== null && r !== null && ke(r), e.callbackNode = null, e.callbackPriority = 0;
      if (!(n & 3) || Qe(e, n)) {
    ...
    function cd(e, t) {
      ...
      var r = J;
      return r = Ze(e, e === K ? r : 0, e.cancelPendingCommit !== null || e.timeoutHandle !== -1), r === 0 ? null : (gu(e, r, t), sd(e, M()), e.callbackNode != null && e.callbackNode === n ? cd.bind(null, e) : null)
    }
    ...
    function wd(e, t, n, r, i) {
      ...
      pn(function() {
        ...
        if (!(t & 7)) {
          ...
          else or ? ir(e, n) && (x = `onCompositionEnd`) : e === `keydown` && n.keyCode === 229 && (x = `onCompositionStart`);x && (tr && n.locale !== `ko` && (or || x !== `onCompositionStart` ? x === `onCompositionEnd` && or && (b = xn()) : (vn = i, yn = `value` in vn ? vn.value : vn.textContent, or = !0)), y = Ed(r, x), 0 < y.length && (x = new zn(x, e, null, n, i), s.push({
            event: x,
            listeners: y
          }), b ? x.data = b : (b = ar(n), b !== null && (x.data = b)))),
          (b = er ? sr(e, n) : cr(e, n)) && (x = Ed(r, `onBeforeInput`), 0 < x.length && (y = new zn(`onBeforeInput`, `beforeinput`, null, n, i), s.push({
            event: y,
            listeners: x
          }), y.data = b)),
          md(s, e, r, n, i)
...
`).replace(Ad, ``)
    ...
    function $(e, t, n, r, a, o) {
      switch (n) {
        ...
        case `textContent`:
          break;
        default:
          (!(2 < n.length) || n[0] !== `o` && n[0] !== `O` || n[1] !== `n` && n[1] !== `N`) && (n = nn.get(n) || n, Pt(e, n, r))
      }
    }
    ...
    function kf(e, t, n, r) {
      ...
      switch (e) {
        ...
        case `title`:
          return null;
        case `style`:
          return typeof n.precedence == `string` && typeof n.href == `string` ? (t = Af(n.href), n = wt(a).hoistableStyles, r = n.get(t), r || (r = {
            type: `style`,
            instance: null,
            count: 0,
            state: null
        ...
        case `link`:
          ...
          return null;
        case `script`:
          return t = n.async, n = n.src, typeof n == `string` && t && typeof t != `function` && typeof t != `symbol` ? (t = Pf(n), n = wt(a).hoistableScripts, r = n.get(t), r || (r = {
            type: `script`,
            instance: null,
            count: 0,
            state: null
    ...
    function If(e, t, n) {
      if (t.count++, t.instance === null) switch (t.type) {
        ...
        case `script`:
          return o = Pf(n.src), (a = e.querySelector(Ff(o))) ? (t.instance = a, Tt(a), a) : (r = n, (a = mf.get(o)) && (r = h({}, n), zf(r, a)), e = e.ownerDocument || e, a = e.createElement(`script`), Tt(a), Pd(a, `link`, r), e.head.appendChild(a), t.instance = a);
        case `void`:
          return null;
        default:
    ...
    function np(e, t, n, r, i, a) {
      i = tp(i), r.context === null ? r.context = i : r.pendingContext = i, r = qa(t), r.payload = {
        element: n
      }, a = a === void 0 ? null : a, a !== null && (r.callback = a), n = Ja(e, r, t), n !== null && (hu(n, e, t), Ya(n, e, t))
    }
...
function b() {
  return crypto.getRandomValues(y)
}
...
var C = c(u(), 1),
  ...
  ee = class {
    ...
    execute(e) {
      e.execute(), this.undoStack.push(e), this.redoStack = [], this.undoStack.length > this.maxSize && this.undoStack.shift()
    }
    undo() {
      let e = this.undoStack.pop();
      return e ? (e.undo(), this.redoStack.push(e), e) : null
    }
    redo() {
      let e = this.redoStack.pop();
      return e ? (e.execute(), this.undoStack.push(e), e) : null
    }
    canUndo() {
  ...
  te = class {
    ...
    id = x();
    constructor(e, t, n) {
      this.description = e, this.execute = t, this.undo = n
    }
  },
  ne = {
    enabled: !0,
  ...
  re = class {
    ...
    snapNodeToGrid(e) {
      return !this.config.enabled || !this.config.nodeSnap ? {
        snapped: e,
        type: `node`,
        distance: 0
      } : {
    ...
    snapHandleToGrid(e) {
      return !this.config.enabled || !this.config.handleSnap ? {
        snapped: e,
        type: `handle`,
        distance: 0
      } : {
    ...
    snap(e) {
      return !this.config.enabled || !this.config.gridSnap ? {
        snapped: e,
        type: `grid`,
        distance: 0
      } : this.snapToGrid(e)
    ...
    snapToGrid(e) {
      let t = Math.max(1, this.config.gridSize),
        n = {
      ...
      return {
        snapped: n,
        type: `grid`,
        distance: Math.hypot(n.x - e.x, n.y - e.y)
      }
    }
  },
  T = class e {
    static generateSmoothPath(e) {
      let t = e.map(e => e.worldPos);
      if (t.length < 2) return ``;
      let n = `M ${t[0].x} ${t[0].y}`;
      for (let t = 0; t < e.length - 1; t += 1) {
        let r = e[t],
          i = e[t + 1];
        if (!(r.handleOut || i.handleIn)) {
          n += ` L ${i.worldPos.x} ${i.worldPos.y}`;
          continue
        }
        let a = r.handleOut ?? r.worldPos,
          o = i.handleIn ?? i.worldPos;
        n += ` C ${a.x} ${a.y}, ${o.x} ${o.y}, ${i.worldPos.x} ${i.worldPos.y}`
      }
      return n
    }
    static generateStraightPath(e) {
      if (e.length < 2) return ``;
      let [t, ...n] = e;
      return n.reduce((e, t) => `${e} L ${t.worldPos.x} ${t.worldPos.y}`, `M ${t.worldPos.x} ${t.worldPos.y}`)
    }
    static getStrokeStyle(e, t) {
      switch (e) {
        case `dual-segment`:
          return {
            strokeWidth: t
    ...
    static lineProgress(e, t, n) {
      return n <= 0 ? +(e >= t) : Math.max(0, Math.min(1, (e - t) / n))
    }
    static ease(e, t) {
    ...
    static easedLineProgress(t, n, r, i) {
      return e.ease(e.lineProgress(t, n, r), i)
    }
    static pointToPolylineDistance(t, n) {
      if (n.length === 0) return 1 / 0;
      if (n.length === 1) return Math.hypot(t.x - n[0].worldPos.x, t.y - n[0].worldPos.y);
      let r = 1 / 0;
      for (let i = 1; i < n.length; i += 1) r = Math.min(r, e.pointToSegmentDistance(t, n[i - 1].worldPos, n[i].worldPos));
      return r
    }
    static getPointAtRatio(t, n) {
      let r = e.sampleNodes(t);
    ...
    static projectPointToLine(t, n) {
      let r = e.sampleNodes(n.nodes);
      if (r.length < 2) return null;
      let i = e.sampleLength(r);
      if (i <= 0) return null;
      let a = r[0],
        o = 1 / 0,
        s = 0,
      ...
      for (let n = 1; n < r.length; n += 1) {
        let i = r[n - 1],
          l = r[n],
          u = e.projectPointToSegment(t, i, l),
          d = Math.hypot(t.x - u.point.x, t.y - u.point.y),
          f = Math.hypot(l.x - i.x, l.y - i.y);
        d < o && (o = d, a = u.point, s = c + f * u.t), c += f
      }
      return {
        point: a,
        t: Math.max(0, Math.min(1, s / i)),
        distance: o
      }
    }
    static findNearestLineProjection(t, n) {
      let r = null;
      for (let i of n) {
        if (!i.visible || i.nodes.length < 2) continue;
        let n = e.projectPointToLine(t, i);
        n && (!r || n.distance < r.distance) && (r = {
          lineId: i.id,
          ...n
        })
      }
    ...
    static pointToSegmentDistance(e, t, n) {
      let r = n.x - t.x,
        i = n.y - t.y,
        a = r * r + i * i;
    ...
    static projectPointToSegment(e, t, n) {
      let r = n.x - t.x,
        i = n.y - t.y,
        a = r * r + i * i;
      if (a === 0) return {
    ...
    static sampleNodes(t, n = 24) {
      ...
      for (let i = 0; i < t.length - 1; i += 1) {
        let a = t[i],
          o = t[i + 1];
        if (!(a.handleOut || o.handleIn)) {
          r.push({
            ...o.worldPos
          });
          continue
        }
        let s = a.handleOut ?? a.worldPos,
          c = o.handleIn ?? o.worldPos;
        for (let t = 1; t <= n; t += 1) {
          let i = t / n;
          r.push(e.cubicAt(a.worldPos, s, c, o.worldPos, i))
        }
      }
      return r
    }
    static cubicAt(e, t, n, r, i) {
      let a = 1 - i;
      return {
        x: a ** 3 * e.x + 3 * a ** 2 * i * t.x + 3 * a * i ** 2 * n.x + i ** 3 * r.x,
        y: a ** 3 * e.y + 3 * a ** 2 * i * t.y + 3 * a * i ** 2 * n.y + i ** 3 * r.y
      }
    }
    static sampleLength(e) {
      let t = 0;
      for (let n = 1; n < e.length; n += 1) t += Math.hypot(e[n].x - e[n - 1].x, e[n].y - e[n - 1].y);
      return t
    }
  },
  ie = o((e => {
  ...
  D = {
    ...
    ui: {
      ...
      availableFonts: [],
      globalNodePointType: `symmetric`,
      globalExtendDirection: `end`
    }
  },
  O = (0, C.createContext)(null);

function le({
  children: e
}) {
  let [t, n] = (0, C.useState)(D), r = (0, C.useRef)(new ee(200)), i = (0, C.useRef)(new re(ce));
  return (0, C.useEffect)(() => {
    i.current.updateConfig(t.snapConfig)
  }, [t.snapConfig]), (0, E.jsx)(O.Provider, {
    value: {
      state: t,
      setState: n,
      commandHistory: r,
...
function de(e, t) {
  let n = t === `pan` ? `pan` : t === `draw-line` || t.startsWith(`shape-`) ? `draw` : t === `select` ? `select` : `edit`;
  e(e => ({
    ...e,
    editor: {
      ...e.editor,
      ...
      dragMode: `idle`,
      selectedHandle: null,
      ...t === `draw-line` || t.startsWith(`shape-`) ? {
        isDrawing: !1,
        drawingLineId: null,
        selectedNodeId: null
      } : {}
...
function j(e, t, n, r, i) {
  t.current.execute(new te(n, () => e(e => ({
    ...r(e),
    historyVersion: e.historyVersion + 1
  })), () => e(e => ({
    ...i(e),
    historyVersion: e.historyVersion + 1
  }))))
...
function _e(e, t, n, r, i) {
  ...
  e(e => ({
    ...
    lines: e.lines.map(e => e.id === t ? {
      ...
      nodes: e.nodes.map(e => {
        if (e.id !== n) return e;
        if (e.pointType !== `symmetric`) return {
          ...e,
          [a]: i,
          pointType: e.pointType ?? `smooth`
        };
        let t = {
          x: e.worldPos.x * 2 - i.x,
          y: e.worldPos.y * 2 - i.y
        };
        return r === `in` ? {
          ...e,
          handleIn: i,
...
function be(e, t, n) {
  e(e => ({
    ...e,
    stations: e.stations.map(e => e.id === t ? {
      ...e,
      ...n
    } : e)
  }))
...
function ShapeUpdate(e, t, n) {
  e(e => ({
    ...e,
    shapes: e.shapes.map(e => e.id === t ? {
      ...e,
      ...n
    } : e)
  }))
...
function we(e, t, n, r, i = 2) {
  let a = e.nodes.find(e => e.id === t),
    o = n.nodes.find(e => e.id === r);
  return !a || !o ? !1 : Math.hypot(a.worldPos.x - o.worldPos.x, a.worldPos.y - o.worldPos.y) <= i
}

function Te(e, t, n, r, i) {
  return e.mergeRelations.find(e => e.pairs.some(e => e.lineId === t && e.nodeId === n) && e.pairs.some(e => e.lineId === r && e.nodeId === i)) ?? null
}

function Ee(e, t, n) {
  return e.mergeRelations.find(e => e.pairs.some(e => e.lineId === t && e.nodeId === n)) ?? null
}
...
function De(e, t, n) {
  ...
  for (; i.length > 0;) {
    ...
    r.add(t);
    let [n, a] = t.split(`:`);
    for (let t of e.mergeRelations)
      if (t.pairs.some(e => e.lineId === n && e.nodeId === a))
        for (let e of t.pairs) {
          let t = `${e.lineId}:${e.nodeId}`;
          r.has(t) || i.push(t)
        }
  }
...
function Oe(e, t, n, r, i) {
  e(e => {
    ...
    return {
      ...e,
      mergeRelations: [...e.mergeRelations, a]
    }
  })
}
...
function ke(e, t, n) {
  e(e => ({
    ...e,
    mergeRelations: e.mergeRelations.filter(e => !e.pairs.some(e => e.lineId === t && e.nodeId === n))
  }))
}
...
function Ae(e, t, n, r) {
  e(e => {
    ...
    return i.length < 2 ? e : {
      ...e,
      lines: e.lines.map(e => {
        let a = i.find(t => t.lineId === e.id);
        return a ? {
          ...e,
          nodes: e.nodes.map(e => {
            if (e.id !== a.nodeId || a.lineId === t && e.id === n) return e;
            let i = r.x - e.worldPos.x,
              o = r.y - e.worldPos.y;
            return {
              ...e,
              worldPos: {
...
function je(e, t, n) {
  e(e => {
    ...
    let i = e.lines.find(e => e.id === t)?.nodes.find(e => e.id === n);
    if (!i) return e;
    let a = i.handleIn ? {
        x: i.handleIn.x - i.worldPos.x,
        y: i.handleIn.y - i.worldPos.y
      } : null,
      o = i.handleOut ? {
        x: i.handleOut.x - i.worldPos.x,
        y: i.handleOut.y - i.worldPos.y
      } : null;
    return {
      ...e,
      lines: e.lines.map(e => {
        let s = r.find(t => t.lineId === e.id);
        return s ? {
          ...e,
          nodes: e.nodes.map(e => e.id !== s.nodeId || s.lineId === t && e.id === n ? e : {
            ...e,
...
var M = class e {
    static worldToView(e, t) {
      return {
        x: e.x * t.scale + t.x,
        y: e.y * t.scale + t.y
      }
    }
    static viewToWorld(e, t) {
      return {
        x: (e.x - t.x) / t.scale,
        y: (e.y - t.y) / t.scale
      }
    }
    static screenToView(e, t) {
      return {
        x: e,
        y: t
      }
    }
    static viewToScreen(e) {
      return {
        x: e.x,
        y: e.y
      }
    }
    static screenToWorld(t, n, r) {
      return e.viewToWorld(e.screenToView(t, n), r)
    }
    static worldToScreen(t, n) {
      return e.viewToScreen(e.worldToView(t, n))
    }
    static screenLengthToWorld(e, t) {
      return e / t.scale
    }
    static getTransformString(e) {
      return `translate(${e.x}, ${e.y}) scale(${e.scale})`
    }
    static zoomAt(t, n, r, i) {
      let a = Math.max(.05, Math.min(32, t.scale * i)),
        o = e.screenToWorld(n, r, t);
      return {
        x: n - o.x * a,
        y: r - o.y * a,
        scale: a
    ...
    static fitToView(e, t, n, r, i = 48) {
      let a = Math.max(1, t.maxX - t.minX),
        o = Math.max(1, t.maxY - t.minY),
        s = Math.max(1, n - i * 2),
        c = Math.max(1, r - i * 2),
        l = Math.min(s / a, c / o, 4),
        u = (t.minX + t.maxX) / 2,
        d = (t.minY + t.maxY) / 2;
      return {
        x: n / 2 - u * l,
  ...
  Me = [`#d32f2f`, `#1976d2`, `#388e3c`, `#f57c00`, `#7b1fa2`, `#00838f`, `#c2185b`, `#455a64`];
...
function ShapeCreate(e, t) {
  ...
  if (e === `shape-triangle`) return {
    ...n,
    type: `polygon`,
    points: `${t.x},${t.y-46} ${t.x+48},${t.y+38} ${t.x-48},${t.y+38}`
  };
  return {
    ...n,
    type: `rect`,
...
function ShapeMove(e, t, n) {
  ...
  if (e.type === `polygon`) {
    r.points = e.points.split(` `).map(e => {
      let [i, a] = e.split(`,`).map(Number);
      return `${i+t},${a+n}`
    }).join(` `);
    return r
  }
...
function Ie(e) {
  ...
  return {
    handleCanvasClick: (0, C.useCallback)((a, o) => {
      if (t.editor.activeTool !== `draw-line` || t.editor.dragMode !== `idle`) return;
      let s = e(a, o),
        c = r.current.snapNodeToGrid(s),
        l = Pe(c.snapped, t.ui.globalNodePointType),
        u = t.lines.find(e => e.id === t.editor.selectedLineId && !e.locked && e.nodes.length > 0);
      if (!t.editor.isDrawing && u) {
        let e = T.findNearestLineProjection(c.snapped, [u]),
          r = !!(e && e.distance < 16 / t.transform.scale),
          a = u.id;
        j(n, i, r ? `鍦ㄧ嚎璺腑鎻掑叆鑺傜偣` : `寤朵几绾胯矾`, t => ({
          ...t,
          lines: t.lines.map(t => {
            if (t.id !== a) return t;
            if (!r || !e) return {
              ...t,
              nodes: Fe(t.nodes, l, t.extendDirection ?? `end`)
            };
            let n = Math.max(1, Math.min(t.nodes.length, Math.round(e.t * (t.nodes.length - 1)) + 1));
            return {
              ...t,
              nodes: [...t.nodes.slice(0, n), l, ...t.nodes.slice(n)]
            }
          })
        }), e => ({
          ...e,
          lines: e.lines.map(e => e.id === a ? {
            ...e,
            nodes: e.nodes.filter(e => e.id !== l.id)
          } : e)
        })), A(n, {
          isDrawing: !0,
          drawingLineId: a,
      ...
      if (!t.editor.isDrawing || !t.editor.drawingLineId) {
        let e = {
          id: x(),
          name: `绾胯矾 ${t.lines.length+1}`,
          color: Ne(t.lines.length),
          ...
          visible: !0,
          locked: !1,
          extendDirection: t.ui.globalExtendDirection,
          animationDelay: t.lines.length * 400,
        ...
        j(n, i, `娣诲姞绾胯矾`, t => ({
          ...
          ...t,
          lines: t.lines.filter(t => t.id !== e.id)
        })), A(n, {
          isDrawing: !0,
          drawingLineId: e.id,
          selectedLineId: e.id,
      ...
      let d = t.editor.drawingLineId;
      t.lines.find(e => e.id === d)?.locked || (j(n, i, `娣诲姞鑺傜偣`, e => ({
        ...e,
        lines: e.lines.map(e => e.id === d ? {
          ...e,
          nodes: Fe(e.nodes, l, e.extendDirection ?? `end`)
        } : e)
      }), e => ({
        ...e,
        lines: e.lines.map(e => e.id === d ? {
...
function Re(e) {
  ...
  return {
    handleNodeMouseDown: (0, C.useCallback)((e, r, i, o = `node`) => {
      e.stopPropagation();
      let s = t.lines.find(e => e.id === r),
        c = s?.nodes.find(e => e.id === i);
      A(n, {
        selectedLineId: r,
        selectedNodeId: i,
        selectedStationId: null,
        selectedTextId: null,
        selectedHandle: o === `handle-in` ? `in` : o === `handle-out` ? `out` : null
      }), !(!s || !c || s.locked) && (a.current = {
        lineId: r,
        nodeId: i,
        kind: o,
        startPos: {
          ...o === `node` ? c.worldPos : o === `handle-in` ? c.handleIn ?? c.worldPos : c.handleOut ?? c.worldPos
        },
        beforeLines: Le(t.lines)
      }, A(n, {
        dragMode: o === `node` ? `dragging-node` : `dragging-handle`
      }))
    }, [n, t.lines]),
    handleNodeDrag: (0, C.useCallback)((i, o) => {
      if (!a.current) return null;
      let s = a.current;
      if (t.lines.find(e => e.id === s.lineId)?.locked) return null;
      let c = e(i, o);
      if (s.kind === `node`) {
        let e = r.current.snapNodeToGrid(c);
        he(n, s.lineId, s.nodeId, e.snapped)
      } else {
        let e = r.current.snapHandleToGrid(c).snapped;
        _e(n, s.lineId, s.nodeId, s.kind === `handle-in` ? `in` : `out`, e)
      }
      return {
        lineId: s.lineId,
        nodeId: s.nodeId
    ...
    handleNodeMouseUp: (0, C.useCallback)(() => {
      let e = a.current;
      if (a.current = null, A(n, {
          dragMode: `idle`
        }), !e?.startPos) return !1;
      let r = t.lines.find(t => t.id === e.lineId)?.nodes.find(t => t.id === e.nodeId),
        o = e.kind === `node` ? r?.worldPos : e.kind === `handle-in` ? r?.handleIn : r?.handleOut;
      if (!o || Math.hypot(o.x - e.startPos.x, o.y - e.startPos.y) < .1) return !1;
      let s = Le(t.lines),
        c = e.beforeLines;
      return j(n, i, e.kind === `node` ? `Move node` : `Move handle`, e => ({
        ...e,
        lines: s
      }), e => ({
        ...e,
...
function ze(e) {
  let {
    ...
    if (!i) return;
    let a = r.clientX - i.left,
      o = r.clientY - i.top,
      s = r.deltaY < 0 ? 1.1 : 1 / 1.1;
    ue(n, M.zoomAt(t.transform, a, o, s))
  }, [t.transform, e, n]);
  return (0, C.useEffect)(() => {
    let t = e.current;
    if (t) return t.addEventListener(`wheel`, a, {
      passive: !1
    }), () => t.removeEventListener(`wheel`, a)
  }, [e, a]), {
    handleMouseDown: (0, C.useCallback)(e => {
      (t.editor.activeTool === `pan` || e.button === 1 || e.button === 0 && e.shiftKey) && (r.current = !0, i.current = {
        x: e.clientX,
        y: e.clientY,
        tx: t.transform.x,
        ty: t.transform.y
      }, e.preventDefault())
    }, [t.editor.activeTool, t.transform]),
    handleMouseMove: (0, C.useCallback)(e => {
      if (!r.current) return;
      let a = e.clientX - i.current.x,
        o = e.clientY - i.current.y;
      ue(n, M.pan({
        ...t.transform,
        x: i.current.tx,
        y: i.current.ty
    ...
    handleMouseUp: (0, C.useCallback)(() => {
      r.current = !1
    }, []),
    handleZoomFit: (0, C.useCallback)(() => {
      if (!e.current) return;
      ...
      let i = 1 / 0,
        ...
        s = -1 / 0,
        c = !1;
      t.mapImageSize && (i = 0, a = 0, o = t.mapImageSize.width, s = t.mapImageSize.height, c = !0);
      for (let e of t.lines)
        for (let t of e.nodes) i = Math.min(i, t.worldPos.x), a = Math.min(a, t.worldPos.y), o = Math.max(o, t.worldPos.x), s = Math.max(s, t.worldPos.y), c = !0;
      c && ue(n, M.fitToView(t.transform, {
        minX: i,
        minY: a,
        maxX: o,
        maxY: s
    ...
    handleZoomReset: (0, C.useCallback)(() => {
      ue(n, {
        x: 0,
        y: 0,
        scale: 1
    ...
    screenToWorld: (0, C.useCallback)((e, n) => M.screenToWorld(e, n, t.transform), [t.transform]),
...
var Be = [{
  ...
  Ve = () => {
    let {
      state: e,
      setState: t
    } = k(), n = (0, C.useRef)(null), r = (0, C.useRef)(0), i = (0, C.useMemo)(() => {
      let t = e.lines.reduce((e, t) => Math.max(e, t.animationDelay + t.animationDuration), 0),
        n = e.stations.reduce((t, n) => {
          let r = n.binding ? e.lines.find(e => e.id === n.binding?.lineId) : null,
            i = r && n.binding ? r.animationDelay + r.animationDuration * n.binding.t : 0;
          return Math.max(t, i + (n.animationDelay ?? 120) + (n.animationDuration ?? 420))
        }, 0);
      return Math.max(t, n)
    }, [e.lines, e.stations]), a = (0, C.useCallback)(() => {
      n.current !== null && (cancelAnimationFrame(n.current), n.current = null)
    }, []), o = (0, C.useCallback)(o => {
      a(), r.current = performance.now() - o, t(e => ({
        ...e,
        isAnimationPlaying: !0,
        animationTotalDuration: i
      }));
      let s = a => {
        let o = Math.min(a - r.current, i),
          c = e.lines.filter(e => o >= e.animationDelay + e.animationDuration).map(e => e.id);
        t(e => ({
          ...e,
          animationCurrentTime: o,
          animationCompletedIds: c,
          isAnimationPlaying: o < i
        })), o < i ? n.current = requestAnimationFrame(s) : n.current = null
      };
      n.current = requestAnimationFrame(s)
    }, [t, e.lines, a, i]), s = (0, C.useCallback)(() => {
      t(e => ({
        ...e,
        animationCurrentTime: 0,
        animationCompletedIds: []
      })), o(0)
    }, [o, t]), c = (0, C.useCallback)(() => {
      ...
      let n = e.animationCurrentTime >= i ? 0 : e.animationCurrentTime;
      n === 0 && t(e => ({
        ...e,
        animationCompletedIds: []
      })), o(n)
    }, [o, t, e.animationCurrentTime, e.isAnimationPlaying, a, i]);
    (0, C.useEffect)(() => a, [a]);
    let l = i > 0 ? Math.min(e.animationCurrentTime / i, 1) : 0,
      u = e => `${(e/1e3).toFixed(1)}s`;
    return (0, E.jsxs)(`div`, {
      ...
      children: [(0, E.jsx)(`div`, {
        ...
        children: [u(e.animationCurrentTime), ` / `, u(i)]
      }), (0, E.jsx)(`select`, {
        className: `easing-select`,
        value: e.animationEasing,
        onChange: e => t(t => ({
          ...t,
          animationEasing: e.target.value
        })),
        children: Be.map(e => (0, E.jsx)(`option`, {
          value: e.value,
          children: e.label
        }, e.value))
      }), (0, E.jsx)(`button`, {
        ...
        onClick: c,
        disabled: i === 0,
        children: e.isAnimationPlaying ? `鏆傚仠` : e.animationCurrentTime > 0 ? `缁х画` : `鎾斁`
      }), (0, E.jsx)(`button`, {
        className: `panel-button`,
        onClick: s,
        disabled: i === 0,
  ...
  He = () => {
    ...
    if (!e.editor.isDrawing || !e.editor.drawingLineId) return null;
    let t = e.lines.find(t => t.id === e.editor.drawingLineId);
    if (!t || t.nodes.length === 0) return null;
  ...
  Ue = ({
    ...
    let {
      ...
      startX: Math.floor(-r.x / r.scale / e) * e - e,
      startY: Math.floor(-r.y / r.scale / e) * e - e,
      endX: Math.ceil((-r.x + i.width) / r.scale / e) * e + e,
      endY: Math.ceil((-r.y + i.height) / r.scale / e) * e + e
    }), [i.height, i.width, e, r]), o = (0, C.useMemo)(() => {
      let t = [];
      for (let n = a.startX; n <= a.endX; n += e) t.push(`M ${n} ${a.startY} L ${n} ${a.endY}`);
      for (let n = a.startY; n <= a.endY; n += e) t.push(`M ${a.startX} ${n} L ${a.endX} ${n}`);
      return t
    }, [a, e]);
    return r.scale < .12 ? null : (0, E.jsxs)(`g`, {
      opacity: t,
      style: {
        pointerEvents: `none`
      },
      children: [o.map(e => (0, E.jsx)(`path`, {
        d: e,
        fill: `none`,
        stroke: `#cbd5e1`,
        strokeWidth: 1 / r.scale
      }, e)), (0, E.jsx)(`circle`, {
        cx: 0,
        cy: 0,
        r: 3 / r.scale,
  ...
  We = () => {
    let {
      ...
      setState: t,
      commandHistory: n
    } = k(), r = (0, C.useRef)(null), i = e.animationCurrentTime > 0 || e.isAnimationPlaying, a = e.lines.filter(t => t.visible ? i ? T.lineProgress(e.animationCurrentTime, t.animationDelay, t.animationDuration) > 0 : !0 : !1);
    ...
    let o = (i, a) => {
      ...
      let o = e => {
          let n = r.current;
          if (!n) return;
          let i = e.clientX - n.startX,
            a = e.clientY - n.startY;
          n.mode === `move` ? Se(t, {
            x: n.before.x + i,
            y: Math.max(48, n.before.y + a)
          }) : Se(t, {
            width: Math.max(130, n.before.width + i),
            height: Math.max(72, n.before.height + a)
          })
        },
        s = e => {
          let i = r.current;
          if (r.current = null, window.removeEventListener(`mousemove`, o), window.removeEventListener(`mouseup`, s), !i) return;
          let a = e.clientX - i.startX,
            c = e.clientY - i.startY,
            l = i.mode === `move` ? {
              ...i.before,
              x: i.before.x + a,
              y: Math.max(48, i.before.y + c)
            } : {
              ...i.before,
              width: Math.max(130, i.before.width + a),
              height: Math.max(72, i.before.height + c)
            };
          j(t, n, i.mode === `move` ? `绉诲姩鍥句緥` : `璋冩暣鍥句緥`, e => ({
            ...e,
            legend: l
          }), e => ({
            ...e,
    ...
    return (0, E.jsxs)(`div`, {
      ...
      style: {
        left: e.legend.x || void 0,
        top: e.legend.y,
        right: e.legend.x === 0 ? 288 : void 0,
        width: e.legend.width,
        minHeight: e.legend.height,
        opacity: e.legend.opacity,
        borderRadius: e.legend.borderRadius
      },
      children: [(0, E.jsx)(`div`, {
        className: `legend-title`,
        onMouseDown: e => o(e, `move`),
        children: `鍥句緥`
      }), (0, E.jsx)(`div`, {
        className: `legend-content`,
        children: a.map(e => (0, E.jsxs)(`div`, {
          ...
          children: [(0, E.jsx)(`svg`, {
            ...
            viewBox: `0 0 36 12`,
            "aria-hidden": `true`,
            children: e.style === `double` ? (0, E.jsxs)(E.Fragment, {
              ...
              y2: 6,
              stroke: e.color,
              strokeWidth: e.style === `metro` ? 5 : 3,
              strokeDasharray: e.style === `dual-segment` ? `7 4` : void 0,
              strokeLinecap: `round`
            })
          }), (0, E.jsx)(`span`, {
            children: e.name
        ...
        className: `legend-resize`,
        "aria-label": `璋冩暣鍥句緥澶у皬`,
        onMouseDown: e => o(e, `resize`)
      })]
    })
  };
...
function Ge({
  ...
  return (0, E.jsxs)(`svg`, {
    ...
    height: `16`,
    "aria-hidden": `true`,
    children: [e === `eye` && (0, E.jsxs)(E.Fragment, {
    ...
    }), e === `eye-off` && (0, E.jsxs)(E.Fragment, {
      children: [(0, E.jsx)(`path`, {
        ...t,
        d: `M3 3l18 18`
      }), (0, E.jsx)(`path`, {
        ...t,
        d: `M10.5 5.2A10.8 10.8 0 0 1 12 5c6 0 10 7 10 7a18 18 0 0 1-3 3.9`
      }), (0, E.jsx)(`path`, {
        ...t,
        d: `M6.1 6.1C3.5 8 2 12 2 12s4 7 10 7a10.7 10.7 0 0 0 4.1-.8`
      })]
    }), e === `lock` && (0, E.jsxs)(E.Fragment, {
...
var Ke = () => {
    let {
      ...
      setState: t,
      commandHistory: n
    } = k(), [r, i] = (0, C.useState)(!1), a = (r, i) => {
      e.lines.find(e => e.id === r) && j(t, n, i ? `Show line` : `Hide line`, e => ({
        ...e,
        lines: e.lines.map(e => e.id === r ? {
          ...e,
          visible: i
        } : e)
      }), e => ({
      ...
      let i = e.lines.find(e => e.id === r);
      if (!i) return;
      let a = !(i.locked ?? !1);
      j(t, n, a ? `Lock line` : `Unlock line`, e => ({
        ...e,
        lines: e.lines.map(e => e.id === r ? {
          ...e,
          locked: a
      ...
      e.lines.find(e => e.id === n)?.locked || pe(t, n, {
        name: r
      })
    };
    return e.lines.length === 0 ? null : (0, E.jsxs)(`div`, {
      className: `layer-panel ${r?`collapsed`:``}`,
      children: [(0, E.jsxs)(`div`, {
        ...
        children: [(0, E.jsx)(`span`, {
          ...
          className: `layer-panel-count`,
          children: e.lines.length
        }), (0, E.jsx)(`span`, {
          className: `layer-panel-toggle`,
          children: r ? `>` : `v`
        })]
      }), !r && (0, E.jsx)(`div`, {
        className: `layer-panel-list`,
        children: e.lines.map(t => (0, E.jsxs)(`div`, {
          className: `layer-item ${e.editor.selectedLineId===t.id?`selected`:``} ${t.locked?`locked`:``}`,
          onClick: () => s(t.id),
          children: [(0, E.jsx)(`span`, {
            ...
            className: `layer-item-vis ${t.visible?`on`:`off`}`,
            title: t.visible ? `闅愯棌` : `鏄剧ず`,
            onClick: e => {
              e.stopPropagation(), a(t.id, !t.visible)
            },
            children: (0, E.jsx)(Ge, {
              name: t.visible ? `eye` : `eye-off`
            })
          }), (0, E.jsx)(`button`, {
            className: `layer-item-lock ${t.locked?`on`:``}`,
            title: t.locked ? `瑙ｉ攣绾胯矾` : `閿佸畾绾胯矾`,
            onClick: e => {
              e.stopPropagation(), o(t.id)
            },
            children: (0, E.jsx)(Ge, {
              name: t.locked ? `lock` : `unlock`
            })
          }), (0, E.jsxs)(`span`, {
            className: `layer-item-nodes`,
            children: [t.nodes.length, ` 鑺傜偣`]
          })]
        }, t.id))
      })]
    })
  ...
  qe = () => {
    let {
      ...
      setState: t,
      commandHistory: n
    } = k(), r = (0, C.useRef)(null), i = e.lines.find(t => t.id === e.editor.selectedLineId);
    if (!i) return null;
    let a = i.locked ?? !1,
      o = i.nodes.find(t => t.id === e.editor.selectedNodeId),
      s = [{
        id: `solid`,
        label: `绾壊`
      }, {
      ...
      c = (e, a = `Edit line`) => {
        let o = r.current ?? i;
        r.current = null, j(t, n, a, t => ({
          ...t,
          lines: t.lines.map(t => t.id === i.id ? {
            ...t,
            ...e
          } : t)
        }), e => ({
          ...e,
          lines: e.lines.map(e => e.id === i.id ? o : e)
        }))
      },
      l = e => {
        if (!o || a) return;
        let n = Math.max(30, i.width * 8),
          r = e === `corner` ? null : o.handleIn ?? {
            x: o.worldPos.x - n,
            y: o.worldPos.y
          },
          s = e === `corner` ? null : o.handleOut ?? {
            x: o.worldPos.x + n,
            y: o.worldPos.y
          };
        ge(t, i.id, o.id, {
    ...
    return (0, E.jsxs)(`div`, {
      ...
      children: [(0, E.jsxs)(`div`, {
        ...
        children: [(0, E.jsx)(`span`, {
          ...
          className: `segmented`,
          children: s.map(e => (0, E.jsx)(`button`, {
            className: i.style === e.id ? `active` : ``,
            disabled: a,
            onClick: () => c({
              style: e.id
            }, `Change line style`),
        ...
        children: [(0, E.jsx)(`span`, {
          ...
          children: [(0, E.jsx)(`button`, {
            className: (i.extendDirection ?? `end`) === `start` ? `active` : ``,
            disabled: a,
            onClick: () => {
              c({
                extendDirection: `start`
              }, `Change extend direction`), Ce(t, {
                globalExtendDirection: `start`
              })
            },
            children: `浠庤捣鐐筦
          }), (0, E.jsx)(`button`, {
            className: (i.extendDirection ?? `end`) === `end` ? `active` : ``,
            disabled: a,
            onClick: () => {
              c({
                extendDirection: `end`
      ...
      }), i.style === `dual-segment` && (0, E.jsxs)(E.Fragment, {
        children: [(0, E.jsxs)(`div`, {
          className: `field`,
          children: [(0, E.jsx)(`span`, {
            children: `鍙岃壊鍒嗘棰滆壊`
          ...
          children: [(0, E.jsxs)(`span`, {
            children: [`鍒嗘闀垮害: `, i.segmentLength ?? 28, `px`]
          }), (0, E.jsx)(`input`, {
            type: `range`,
            min: 6,
            max: 96,
            step: 2,
            value: i.segmentLength ?? 28,
            disabled: a,
            onChange: e => pe(t, i.id, {
              segmentLength: Number(e.target.value)
            })
          })]
        }), (0, E.jsxs)(`label`, {
          className: `field`,
          children: [(0, E.jsxs)(`span`, {
            children: [`鍒嗘闂撮殧: `, i.segmentGap ?? 0, `px`]
          }), (0, E.jsx)(`input`, {
            type: `range`,
            min: 0,
            max: 48,
            step: 2,
            value: i.segmentGap ?? 0,
            disabled: a,
            onChange: e => pe(t, i.id, {
              segmentGap: Number(e.target.value)
            })
          })]
        }), (0, E.jsxs)(`label`, {
          className: `check-row`,
          children: [(0, E.jsx)(`input`, {
            type: `checkbox`,
            checked: i.roundCap ?? !1,
            disabled: a,
            onChange: () => pe(t, i.id, {
              roundCap: !(i.roundCap ?? !1)
            })
          }), `浣跨敤鍦嗗ご`]
        }), (0, E.jsxs)(`label`, {
          className: `field`,
          children: [(0, E.jsx)(`span`, {
            ...
            value: i.segmentJoin ?? `round`,
            disabled: a,
            onChange: e => pe(t, i.id, {
              segmentJoin: e.target.value
            }),
        ...
        className: `field`,
        children: [(0, E.jsxs)(`span`, {
          children: [`鍔ㄧ敾鏃堕暱: `, i.animationDuration, `ms`]
        }), (0, E.jsx)(`input`, {
          type: `range`,
          min: 500,
          max: 8e3,
        ...
        className: `field`,
        children: [(0, E.jsxs)(`span`, {
          children: [`鍔ㄧ敾寤惰繜: `, i.animationDelay, `ms`]
        }), (0, E.jsx)(`input`, {
          type: `range`,
          min: 0,
          max: 8e3,
          step: 100,
          value: i.animationDelay,
          disabled: a,
          onPointerDown: () => {
            r.current = i
          },
        ...
        className: `field anchor-editor`,
        children: [(0, E.jsx)(`span`, {
          children: `鑺傜偣绫诲瀷`
        }), (0, E.jsx)(`div`, {
          className: `segmented`,
          children: [`corner`, `smooth`, `symmetric`].map(e => (0, E.jsx)(`button`, {
            className: (o.pointType ?? `corner`) === e ? `active` : ``,
            disabled: a,
            onClick: () => l(e),
            children: e === `corner` ? `瑙掔偣` : e === `smooth` ? `骞虫粦` : `瀵圭О`
          }, e))
        }), (0, E.jsx)(`div`, {
          className: `panel-meta`,
          children: `鎺у埗鏌勪粎鍦ㄩ€変腑鑺傜偣鏃舵樉绀猴紱瀵圭О鑺傜偣浼氶暅鍍忎袱渚ф帶鍒舵焺銆俙
        })]
      }), (0, E.jsxs)(`label`, {
        className: `check-row`,
        children: [(0, E.jsx)(`input`, {
        ...
        className: `panel-meta`,
        children: [`鑺傜偣鏁?`, i.nodes.length, a ? ` 路 宸查攣瀹歚 : ``]
      }), e.editor.selectedNodeId && (() => {
        let n = Ee(e, i.id, e.editor.selectedNodeId);
        if (!n) return null;
        let r = n.pairs.filter(t => t.lineId !== i.id || t.nodeId !== e.editor.selectedNodeId);
        return (0, E.jsxs)(`div`, {
          className: `panel-meta`,
          style: {
            background: `#f0f9ff`,
          ...
          children: [(0, E.jsx)(`div`, {
            ...
            children: `骞剁嚎鐘舵€乣
          }), r.map(t => (0, E.jsxs)(`div`, {
            style: {
              fontSize: 10
            },
            children: [`宸插叧鑱?`, e.lines.find(e => e.id === t.lineId)?.name ?? t.lineId.slice(0, 8)]
          }, `${t.lineId}-${t.nodeId}`)), (0, E.jsx)(`button`, {
            disabled: a,
            style: {
              marginTop: 4,
              padding: `2px 8px`,
            ...
            onClick: () => ke(t, i.id, e.editor.selectedNodeId),
            children: `鍙栨秷骞剁嚎`
          })]
        })
      })(), (0, E.jsx)(`button`, {
  ...
  Je = () => {
    let {
      ...
      e.type = `file`, e.accept = `image/png,image/jpeg,image/jpg,image/webp`, e.onchange = e => {
    ...
    return e.mapImage ? (0, E.jsx)(`image`, {
      href: e.mapImage,
      x: 0,
      y: 0,
      width: e.mapImageSize?.width ?? 0,
      height: e.mapImageSize?.height ?? 0,
      ...
      children: [(0, E.jsx)(`rect`, {
        ...
        fontSize: 13,
        fontFamily: `system-ui, sans-serif`,
        children: `鎵€鏈夊湴鍥俱€佺嚎璺€佽妭鐐瑰拰鍔ㄧ敾鍧囩粦瀹氬埌鍚屼竴涓栫晫鍧愭爣绯籤
      })]
    })
  },
  Ye = (e, t, n, r, i) => {
  ...
  Xe = (e, t, n = 32) => {
    let r = e.nodes[t],
      i = e.nodes[t + 1];
    if (!r || !i) return [];
    if (!(r.handleOut || i.handleIn)) return [{
      ...r.worldPos
    }, {
      ...i.worldPos
    }];
    ...
    for (let e = 1; e <= n; e += 1) s.push(Ye(r.worldPos, a, o, i.worldPos, e / n));
    return s
  },
  Ze = (e, t) => e.map((n, r) => {
    let i = e[Math.max(0, r - 1)],
      a = e[Math.min(e.length - 1, r + 1)],
      o = a.x - i.x,
      s = a.y - i.y,
      c = Math.hypot(o, s) || 1;
    return {
  ...
  Qe = e => {
    ...
    let [t, ...n] = e;
    return n.reduce((e, t) => `${e} L ${t.x} ${t.y}`, `M ${t.x} ${t.y}`)
  },
  $e = e => {
    let t = 0;
    for (let n = 1; n < e.length; n += 1) t += Math.hypot(e[n].x - e[n - 1].x, e[n].y - e[n - 1].y);
  ...
  et = (e, t, n) => {
    let r = e.nodes.slice(0, -1).map((t, n) => $e(Xe(e, n))),
      i = r.reduce((e, t) => e + t, 0);
    if (i <= 0) return +(n > 0);
    let a = r.slice(0, t).reduce((e, t) => e + t, 0) / i,
      o = a + r[t] / i;
    return n <= a ? 0 : n >= o ? 1 : (n - a) / Math.max(1e-4, o - a)
  },
  tt = ({
    onNodeMouseDown: e,
    onNodeClick: t,
    ...
    let {
      ...
      let e = [],
        t = i.lines.filter(e => e.visible),
        n = i.animationCurrentTime > 0 || i.isAnimationPlaying,
        r = e => n ? T.easedLineProgress(i.animationCurrentTime, e.animationDelay, e.animationDuration, i.animationEasing) : 1,
        a = new Map,
        o = (e, t) => `${e}:${t}`,
        s = e => {
          let t = a.get(e) ?? e;
          if (t === e) return a.set(e, e), e;
          let n = s(t);
          return a.set(e, n), n
        },
        c = (e, t) => {
      ...
      for (let e of i.mergeRelations) {
        if (e.pairs.length < 2) continue;
        let t = o(e.pairs[0].lineId, e.pairs[0].nodeId);
        for (let n of e.pairs.slice(1)) c(t, o(n.lineId, n.nodeId))
      }
      let l = new Map;
      for (let e of t)
        for (let t = 0; t < e.nodes.length - 1; t += 1) {
          let n = s(o(e.id, e.nodes[t].id)),
            r = s(o(e.id, e.nodes[t + 1].id));
          if (n === r) continue;
          let i = [n, r].sort(),
            a = `${i[0]}|${i[1]}`,
            c = l.get(a) ?? {
      ...
      for (let [n, i] of l) {
        ...
        let a = i.segments.filter(e => et(e.line, e.segmentIndex, r(e.line)) > 0);
        if (a.length < 2) continue;
        let o = [...i.segments].sort((e, n) => t.findIndex(t => t.id === e.line.id) - t.findIndex(e => e.id === n.line.id))[0],
          s = [...a].sort((e, n) => t.findIndex(t => t.id === e.line.id) - t.findIndex(e => e.id === n.line.id)),
          c = -s.reduce((e, t) => e + t.line.width, 0) / 2;
        for (let t of s) {
          let i = c + t.line.width / 2;
          c += t.line.width;
          let a = Xe(t.line, t.segmentIndex);
          if (a.length < 2) continue;
          let s = t.line.nodes[t.segmentIndex],
            l = t.line.nodes[t.segmentIndex + 1];
          if (Math.hypot(l.worldPos.x - s.worldPos.x, l.worldPos.y - s.worldPos.y) < 1) continue;
          let u = t.startRoot === o.startRoot && t.endRoot === o.endRoot ? i : -i;
          e.push({
            key: `${n}-${t.line.id}-${t.segmentIndex}`,
            lineId: t.line.id,
            pathD: Qe(Ze(a, u)),
            color: t.line.color,
            width: t.line.width,
            progress: et(t.line, t.segmentIndex, r(t.line)),
            totalLength: $e(a)
          })
        }
      }
      return e
    }, [i.animationCurrentTime, i.animationEasing, i.isAnimationPlaying, i.lines, i.mergeRelations]);
    return (0, E.jsxs)(`g`, {
      children: [i.lines.filter(e => e.visible).map(a => (0, E.jsx)(nt, {
        line: a,
        isSelected: a.id === n,
        selectedNodeId: r,
        onNodeMouseDown: e,
        onNodeClick: t,
        currentTime: i.animationCurrentTime,
        isPlaying: i.isAnimationPlaying,
        easing: i.animationEasing,
        scale: i.transform.scale
      }, a.id)), a.filter(e => !(e.progress <= 0 || e.totalLength < 1)).map(e => (0, E.jsx)(`path`, {
        d: e.pathD,
        fill: `none`,
        stroke: e.color,
        strokeWidth: e.width,
  ...
  nt = C.memo(function({
    ...
    let l = (0, C.useMemo)(() => T.generateSmoothPath(e.nodes), [e.nodes]),
      u = (0, C.useMemo)(() => T.getStrokeStyle(e.style, e.width), [e.style, e.width]),
      d = (0, C.useId)().replaceAll(`:`, ``),
      f = `${d}-gradient`,
      p = `${d}-dual-reveal`,
      m = a > 0 || o,
      h = m ? T.easedLineProgress(a, e.animationDelay, e.animationDuration, s) : 1,
      g = Math.max(3.5 / c, Math.min(7 / c, e.width * 1.15)),
      _ = Math.max(1.25 / c, 2 / c);
    if (e.nodes.length === 0) return null;
    if (e.nodes.length === 1) {
      let t = e.nodes[0];
      return (0, E.jsxs)(`g`, {
        children: [(0, E.jsx)(`circle`, {
          ...
          selected: t.id === n,
          locked: e.locked,
          onMouseDown: n => r(n, e.id, t.id)
        })]
      })
    }
    let v = m && h < .003,
      y = Math.max(1, e.segmentLength ?? 28),
      b = Math.max(0, e.segmentGap ?? 0),
      x = `${y} ${y+b}`,
      S = y + b,
      w = e.roundCap ? `round` : `butt`,
      ee = e.segmentJoin ?? `round`,
      te = m ? {
        pathLength: 1,
        strokeDasharray: 1,
    ...
    return (0, E.jsxs)(`g`, {
      ...
      children: [(0, E.jsxs)(`defs`, {
        ...
        d: l,
        fill: `none`,
        stroke: e.locked ? `#f59e0b` : `#111827`,
        strokeWidth: (e.width + 10) / c,
        strokeLinecap: `round`,
        strokeLinejoin: `round`,
        opacity: e.locked ? .26 : .16
      }), e.style === `double` ? (0, E.jsxs)(E.Fragment, {
        children: [(0, E.jsx)(`path`, {
          d: l,
          fill: `none`,
          stroke: e.color,
          strokeWidth: e.width + 4 / c,
          strokeLinecap: `round`,
          strokeLinejoin: `round`,
          ...te
        }), (0, E.jsx)(`path`, {
          ...
          fill: `none`,
          stroke: `#ffffff`,
          strokeWidth: Math.max(1.5 / c, e.width * .45),
          strokeLinecap: `round`,
          strokeLinejoin: `round`,
          ...te
        })]
      }) : e.style === `dual-segment` ? (0, E.jsxs)(`g`, {
        mask: `url(#${p})`,
        children: [(0, E.jsx)(`path`, {
          d: l,
          fill: `none`,
          ...
          d: l,
          fill: `none`,
          stroke: e.secondaryColor ?? `#ffffff`,
          strokeWidth: u.strokeWidth,
          strokeLinecap: w,
          strokeLinejoin: ee,
          strokeDasharray: x,
        ...
        d: l,
        fill: `none`,
        stroke: e.style === `metro` ? `url(#${f})` : e.color,
        strokeWidth: u.strokeWidth,
        strokeLinecap: `round`,
        strokeLinejoin: `round`,
        ...te
        ...
        fill: `none`,
        stroke: `transparent`,
        strokeWidth: (e.width + 14) / c,
        strokeLinecap: `round`,
        strokeLinejoin: `round`,
        style: {
          pointerEvents: `stroke`,
          cursor: e.locked ? `not-allowed` : `pointer`
        }
      }), e.locked && e.nodes[0] && (0, E.jsxs)(`g`, {
        pointerEvents: `none`,
        transform: `translate(${e.nodes[0].worldPos.x+10/c} ${e.nodes[0].worldPos.y-10/c})`,
        children: [(0, E.jsx)(`rect`, {
          x: -5 / c,
          y: -9 / c,
          width: 20 / c,
        ...
        let a = t.id === n && !e.locked;
        return (0, E.jsxs)(`g`, {
          children: [a && t.handleIn && (0, E.jsxs)(E.Fragment, {
            children: [(0, E.jsx)(`line`, {
              x1: t.worldPos.x,
              y1: t.worldPos.y,
              x2: t.handleIn.x,
              ...
              x: t.handleIn.x,
              y: t.handleIn.y,
              radius: Math.max(3 / c, g * .72),
              strokeWidth: _,
              color: `#64748b`,
              selected: !1,
              locked: e.locked,
              onMouseDown: n => r(n, e.id, t.id, `handle-in`)
            })]
          }), a && t.handleOut && (0, E.jsxs)(E.Fragment, {
            children: [(0, E.jsx)(`line`, {
              x1: t.worldPos.x,
              y1: t.worldPos.y,
              x2: t.handleOut.x,
              ...
              selected: !1,
              locked: e.locked,
              onMouseDown: n => r(n, e.id, t.id, `handle-out`)
            })]
          }), (0, E.jsx)(rt, {
            x: t.worldPos.x,
            y: t.worldPos.y,
            ...
            selected: t.id === n,
            locked: e.locked,
            onMouseDown: n => r(n, e.id, t.id, `node`),
            onClick: i ? n => i(n, e.id, t.id) : void 0
          })]
        }, t.id)
      })]
    })
...
var it = ({
  ...
  return (0, E.jsx)(`g`, {
    children: t.stations.map(n => {
      let r = n.id === t.editor.selectedStationId,
        i = n.bindingMode !== `none` && n.binding,
        a = i && n.binding ? t.lines.find(e => e.id === n.binding.lineId) : null,
        o = (a && n.binding ? T.getPointAtRatio(a.nodes, n.binding.t) : null) ?? n.worldPos,
        s = n.animationDuration ?? 420,
        c = n.animationDelay ?? 0;
      if (!(t.animationCurrentTime > 0 || t.isAnimationPlaying)) return at({
        station: n,
        selected: r,
        pos: o,
        isBound: i,
        ...
        fontFamily: t.ui.fontFamily,
        stationFontSize: t.ui.stationFontSize,
        onMouseDown: e
      });
      if (i && a && n.binding) {
        let l = a.animationDelay + a.animationDuration * n.binding.t,
          u = l + Math.min(0, c);
        if (t.animationCurrentTime < u) return null;
        let d = l + c,
          f = d + s;
        if (f <= t.animationCurrentTime) return at({
          station: n,
          selected: r,
          pos: o,
          isBound: i,
        ...
        let p = Math.max(u, d),
          m = (t.animationCurrentTime - p) / (f - p),
          h = Math.max(0, Math.min(1, m));
        return h <= 0 ? null : at({
          station: n,
          selected: r,
          pos: o,
      ...
      let l = T.ease(T.lineProgress(t.animationCurrentTime, c, s), t.animationEasing);
      return l <= 0 ? null : at({
        station: n,
        selected: r,
        pos: o,
...
function at({
  ...
  let l = e.labelPosition ?? `top`,
    u = e.labelOffset ?? {
      x: 0,
      y: 0
    },
    d = e.radius + 6 / a,
    f = n.x + u.x / a + (l === `left` ? -d : l === `right` ? d : 0),
    p = n.y + u.y / a + (l === `top` ? -d : l === `bottom` ? d + s / a : 0),
    m = l === `left` ? `end` : l === `right` ? `start` : `middle`;
  return (0, E.jsxs)(`g`, {
    style: {
      cursor: `move`
    },
    onMouseDown: t => c(t, e.id),
    onClick: e => e.stopPropagation(),
    opacity: i,
    transform: `translate(${n.x} ${n.y}) scale(${.82+i*.18}) translate(${-n.x} ${-n.y})`,
    children: [!r && (0, E.jsx)(`circle`, {
      cx: n.x,
      cy: n.y,
      r: e.radius + 3 / a,
      fill: `none`,
      ...
      r: e.radius,
      fill: e.fill,
      stroke: t ? `#f97316` : e.stroke,
      strokeWidth: t ? 2.5 / a : 1.5 / a
    }), (0, E.jsx)(`circle`, {
      cx: n.x,
      cy: n.y,
      r: Math.max(2 / a, e.radius * .34),
      fill: e.stroke,
      opacity: .9
    }), e.labelVisible && (0, E.jsx)(`text`, {
      x: f,
      y: p,
      textAnchor: m,
      fill: `#111827`,
...
var ot = () => {
    let {
      ...
      setState: t,
      commandHistory: n
    } = k(), r = (0, C.useRef)(null), i = e.stations.find(t => t.id === e.editor.selectedStationId);
    if (!i) return null;
    let a = (e, a = `Edit station`) => {
        let o = r.current ?? i;
        r.current = null, j(t, n, a, t => ({
          ...t,
          stations: t.stations.map(t => t.id === i.id ? {
            ...t,
            ...e
          } : t)
        }), e => ({
          ...e,
          stations: e.stations.map(e => e.id === i.id ? o : e)
        }))
      },
      o = t => {
        if (t === `none`) {
        ...
        let n = e.lines.find(e => e.id === t);
        if (!n || n.locked) return;
        let r = T.projectPointToLine(i.worldPos, n);
        r && a({
          bindingMode: t,
          binding: {
            lineId: t,
    ...
    return (0, E.jsxs)(`div`, {
      className: `line-panel station-panel`,
      children: [(0, E.jsxs)(`div`, {
        className: `panel-header`,
        children: [(0, E.jsx)(`span`, {
          children: `绔欑偣灞炴€
        ...
        children: [(0, E.jsx)(`span`, {
          ...
          children: [(0, E.jsx)(`option`, {
            value: `none`,
            children: `涓嶅惛闄勭嚎璺痐
          }), e.lines.map(e => (0, E.jsxs)(`option`, {
            value: e.id,
            disabled: e.locked,
            children: [e.name, e.locked ? ` (locked)` : ``]
          }, e.id))]
        }), i.bindingMode !== `none` && (0, E.jsxs)(`div`, {
          style: {
            fontSize: 10,
            color: `#64748b`,
            marginTop: 2
          },
          children: [`宸插惛闄勮嚦: `, e.lines.find(e => e.id === i.bindingMode)?.name ?? i.bindingMode, ` | 浣嶇疆: `, ((i.binding?.t ?? 0) * 100).toFixed(1), `%`]
        })]
      }), (0, E.jsxs)(`div`, {
        className: `field`,
        children: [(0, E.jsx)(`span`, {
          ...
          className: `segmented`,
          children: [`top`, `bottom`, `left`, `right`].map(e => (0, E.jsx)(`button`, {
            className: (i.labelPosition ?? `top`) === e ? `active` : ``,
            onClick: () => be(t, i.id, {
              labelPosition: e
            }),
            children: e === `top` ? `涓奰 : e === `bottom` ? `涓媊 : e === `left` ? `宸 : `鍙砢
          }, e))
        })]
      }), (0, E.jsxs)(`label`, {
        className: `field`,
        children: [(0, E.jsxs)(`span`, {
          children: [`鍗婂緞: `, i.radius, `px`]
        }), (0, E.jsx)(`input`, {
          type: `range`,
          min: 4,
          max: 18,
        ...
        className: `field`,
        children: [(0, E.jsxs)(`span`, {
          children: [`鍑虹幇寤惰繜: `, i.animationDelay ?? 0, `ms`]
        }), (0, E.jsx)(`input`, {
          type: `range`,
          min: -1e3,
          max: 3e3,
          step: 50,
          value: i.animationDelay ?? 0,
          onChange: e => be(t, i.id, {
            animationDelay: Number(e.target.value)
          })
        })]
        ...
        className: `field`,
        children: [(0, E.jsxs)(`span`, {
          children: [`鍑虹幇鏃堕暱: `, i.animationDuration ?? 420, `ms`]
        }), (0, E.jsx)(`input`, {
          type: `range`,
          min: 100,
          max: 3e3,
          step: 50,
          value: i.animationDuration ?? 420,
          onChange: e => be(t, i.id, {
            animationDuration: Number(e.target.value)
          })
        })]
        ...
        onClick: () => {
          let e = i;
          j(t, n, `Delete station`, t => ({
            ...t,
            stations: t.stations.filter(t => t.id !== e.id),
            editor: {
              ...t.editor,
              selectedStationId: null
            }
  ...
  st = ({
    ...
    children: [(0, E.jsxs)(`span`, {
      children: [`缂╂斁: `, Math.round(e.scale * 100), `%`]
    }), (0, E.jsxs)(`span`, {
      children: [`瑙嗗彛: (`, Math.round(e.x), `, `, Math.round(e.y), `)`]
    }), (0, E.jsxs)(`span`, {
      children: [`鍧愭爣: Screen `, `->`, ` View `, `->`, ` World`]
    })]
  }),
  ShapeElement = (e, t, a) => {
    let n = {
    ...
    if (e.type === `rect`) return (0, E.jsx)(`rect`, {
      ...n,
      x: e.x,
      y: e.y,
      width: e.width,
      ...
      stroke: t ? `#f97316` : e.stroke,
      strokeWidth: t ? (e.strokeWidth + 2) / a : e.strokeWidth / a,
      strokeDasharray: t ? `${5/a} ${4/a}` : void 0
    });
    if (e.type === `circle`) return (0, E.jsx)(`circle`, {
      ...n,
      cx: e.cx,
      cy: e.cy,
      r: e.r,
    ...
    if (e.type === `ellipse`) return (0, E.jsx)(`ellipse`, {
      ...n,
      cx: e.cx,
      cy: e.cy,
      rx: e.rx,
    ...
    if (e.type === `line`) return (0, E.jsx)(`line`, {
      ...n,
      x1: e.x1,
      y1: e.y1,
      x2: e.x2,
  ...
  ShapeLayer = ({
    ...
    return (0, E.jsx)(`g`, {
      children: t.shapes.filter(e => e.visible).map(n => (0, E.jsx)(`g`, {
        onMouseDown: t => e(t, n.id),
        onClick: e => e.stopPropagation(),
        style: {
          cursor: n.locked ? `not-allowed` : `move`
        },
        children: ShapeElement(n, n.id === t.editor.selectedShapeId, t.transform.scale)
      }, n.id))
    })
  },
  ct = ({
    ...
    return (0, E.jsx)(`g`, {
      children: t.texts.filter(e => e.visible).map(n => {
        let r = n.id === t.editor.selectedTextId;
        return (0, E.jsxs)(`g`, {
          transform: `translate(${n.worldPos.x} ${n.worldPos.y}) rotate(${n.rotation})`,
          style: {
            cursor: `move`
          },
          onMouseDown: t => e(t, n.id),
          onClick: e => e.stopPropagation(),
          children: [r && (0, E.jsx)(`rect`, {
            x: -4 / t.transform.scale,
            y: -n.fontSize / t.transform.scale,
            width: Math.max(48, n.content.length * n.fontSize * .62) / t.transform.scale,
            height: (n.fontSize + 8) / t.transform.scale,
            fill: `none`,
            stroke: `#f97316`,
            strokeWidth: 1.5 / t.transform.scale,
            strokeDasharray: `${4/t.transform.scale} ${3/t.transform.scale}`
          }), (0, E.jsx)(`text`, {
            x: 0,
            y: 0,
            fill: n.fill,
            fontSize: n.fontSize / t.transform.scale,
            fontFamily: n.fontFamily,
            textAnchor: n.anchor,
            dominantBaseline: `alphabetic`,
            paintOrder: `stroke`,
            stroke: `#ffffff`,
            strokeWidth: 2.5 / t.transform.scale,
            children: n.content
          })]
        }, n.id)
      })
  ...
  lt = [`system-ui`, `Arial`, `Helvetica Neue`, `Segoe UI`, `Roboto`, `Open Sans`, `Microsoft YaHei`, `寰蒋闆呴粦`, `SimSun`, `瀹嬩綋`, `SimHei`, `榛戜綋`, `KaiTi`, `妤蜂綋`, `FangSong`, `浠垮畫`, `NSimSun`, `鏂板畫浣揱, `DengXian`, `绛夌嚎`, `YouYuan`, `骞煎渾`, `Microsoft JhengHei`, `寰粺姝ｉ粦楂擿, `PingFang SC`, `鑻规柟-绠€`, `Hiragino Sans GB`, `鍐潚榛戜綋绠€浣撲腑鏂嘸, `Noto Sans CJK SC`, `Noto Serif CJK SC`, `Source Han Sans SC`, `Source Han Serif SC`, `WenQuanYi Micro Hei`, `WenQuanYi Zen Hei`, `Times New Roman`, `Georgia`, `Courier New`, `Consolas`, `Cambria`, `Calibri`, `Verdana`, `Tahoma`, `Trebuchet MS`, `Impact`, `Comic Sans MS`, `Palatino Linotype`, `Book Antiqua`, `Arial Narrow`, `Franklin Gothic Medium`, `Gill Sans`, `Century Gothic`, `Copperplate`, `Lucida Sans Unicode`, `Lucida Grande`, `Monaco`, `Menlo`, `SF Pro Display`, `SF Pro Text`, `Helvetica`, `Candara`, `Constantia`, `Corbel`, `Sylfaen`, `Baskerville`, `Garamond`, `Rockwell`, `Futura`, `Avenir`, `Noto Sans`, `Noto Serif`, `Ubuntu`, `DejaVu Sans`, `DejaVu Serif`, `Liberation Sans`, `Liberation Serif`, `FreeSans`, `FreeSerif`, `Droid Sans`, `Droid Sans Mono`];

function FontFamilyListFromString(e) {
  let t = new Set;
  for (let n of e) n.split(`,`).map(e => e.trim().replace(/^["']|["']$/g, ``)).filter(Boolean).forEach(e => t.add(e));
  return Array.from(t)
}
function ut(e) {
  Ce(e, {
...
function DetectLocalFontCandidates() {
  let e = [`system-ui`];
  if (document.fonts && document.fonts.check) {
    for (let t of lt) {
      if (e.includes(t)) continue;
      try {
        if (document.fonts.check(`12px "${t}"`) || document.fonts.check(`12px '${t}'`) || document.fonts.check(`12px ${t}`)) e.push(t)
      } catch {}
    }
  }
...
async function dt(e, t) {
  let n = window,
    r = DetectLocalFontCandidates();
  if (n.queryLocalFonts) {
    try {
      let i = await n.queryLocalFonts();
      for (let e of i)
        if (e?.family) r.push(e.family)
    } catch {}
  }
  let i = Array.from(new Set(r.filter(Boolean)));
  if (i.length === 1 && i[0] === `system-ui`) i = lt;
  i.sort((e, t) => e.localeCompare(t, `zh`));
  Ce(e, {
    availableFonts: i
  }), t(i)
}
var ft = ({
    ...
    let {
      state: i,
      setState: a
    } = k(), [o, s] = (0, C.useState)(``), [c, l] = (0, C.useState)(!1), [u, d] = (0, C.useState)(!1), [f, p] = (0, C.useState)(i.ui.availableFonts), m = (0, C.useRef)(null), h = (0, C.useRef)(null), g = f.length > 0 ? f : i.ui.availableFonts, _ = o ? g.filter(e => e.toLowerCase().includes(o.toLowerCase())) : g, v = (0, C.useCallback)(() => {
      d(!0), dt(a, e => {
        p(e), d(!1)
      })
    }, [a]), y = (0, C.useCallback)(e => {
      t(e), s(``), l(!1)
    }, [t]);
    (0, C.useEffect)(() => {
      if (!c) return;
      let e = e => {
        m.current && !m.current.contains(e.target) && l(!1)
      };
    ...
    return (0, E.jsxs)(`div`, {
      ...
      children: [(0, E.jsxs)(`div`, {
        ...
        children: [(0, E.jsx)(`input`, {
          ...
          className: `font-selector-arrow`,
          style: {
            transform: c ? `rotate(180deg)` : void 0
          },
          children: `鈻綻
        })]
      }), c && (0, E.jsxs)(`div`, {
        className: `font-selector-dropdown`,
        children: [!u && f.length === 0 && (0, E.jsx)(`button`, {
          className: `font-selector-load-btn`,
          onClick: e => {
            e.stopPropagation(), v()
          },
          disabled: u,
          children: u ? `鈴?姝ｅ湪鍔犺浇绯荤粺瀛椾綋鈥 : `馃枼 鐐瑰嚮鍔犺浇鏈満鎵€鏈夊瓧浣揱
        }), u && f.length === 0 && (0, E.jsx)(`div`, {
          className: `font-selector-loading`,
          children: `姝ｅ湪鏋氫妇绯荤粺瀛椾綋鈥
        }), (0, E.jsxs)(`div`, {
          className: `font-selector-list`,
          children: [_.slice(0, 200).map(t => (0, E.jsx)(`div`, {
            className: `font-selector-item ${t===e?`active`:``}`,
            onClick: e => {
          ...
          }, t)), _.length === 0 && (0, E.jsx)(`div`, {
            className: `font-selector-empty`,
            children: `鏈壘鍒板尮閰嶇殑瀛椾綋`
          }), _.length > 200 && (0, E.jsx)(`div`, {
            className: `font-selector-more`,
            children: `... 浠呮樉绀哄墠 200 椤癸紝璇锋悳绱互缂╁皬鑼冨洿`
          })]
        })]
      })]
    })
  ...
  pt = () => {
    let {
      ...
      setState: t,
      commandHistory: n
    } = k(), r = (0, C.useRef)(null), i = e.texts.find(t => t.id === e.editor.selectedTextId);
    if (!i) return null;
    let a = (e, a = `缂栬緫鏂囨湰`) => {
      let o = r.current ?? i;
      r.current = null, j(t, n, a, t => ({
        ...t,
        texts: t.texts.map(t => t.id === i.id ? {
          ...t,
          ...e
        } : t)
      }), e => ({
        ...e,
        texts: e.texts.map(e => e.id === i.id ? o : e)
      }))
    };
    return (0, E.jsxs)(`div`, {
      className: `line-panel text-panel`,
      children: [(0, E.jsxs)(`div`, {
        className: `panel-header`,
        children: [(0, E.jsx)(`span`, {
          children: `鏂囨湰灞炴€
        ...
        children: [(0, E.jsx)(`span`, {
          ...
          className: `segmented`,
          children: [`start`, `middle`, `end`].map(e => (0, E.jsx)(`button`, {
            className: i.anchor === e ? `active` : ``,
            onClick: () => a({
              anchor: e
            }, `淇敼鏂囨湰瀵归綈`),
            children: e === `start` ? `宸 : e === `middle` ? `涓璥 : `鍙砢
          }, e))
        })]
      }), (0, E.jsxs)(`label`, {
        className: `check-row`,
        ...
        onClick: () => {
          ...
          j(t, n, `鍒犻櫎鏂囨湰`, t => ({
            ...t,
            texts: t.texts.filter(t => t.id !== e.id),
            editor: {
              ...t.editor,
              selectedTextId: null
            }
  ...
  ShapePanel = () => {
    let {
      ...
      setState: t,
      commandHistory: n
    } = k(), r = (0, C.useRef)(null), i = e.shapes.find(t => t.id === e.editor.selectedShapeId);
    if (!i) return null;
    let a = (e, a = `缂栬緫鍑犱綍鍥惧舰`) => {
        let o = r.current ?? i;
        r.current = null, j(t, n, a, t => ({
          ...t,
          shapes: t.shapes.map(t => t.id === i.id ? {
            ...t,
            ...e
          } : t)
        }), e => ({
          ...e,
          shapes: e.shapes.map(e => e.id === i.id ? o : e)
        }))
      },
      s = (e, key, value, step = 1) => (0, E.jsxs)(`label`, {
        className: `field`,
        children: [(0, E.jsx)(`span`, {
          children: [e, `: `, Math.round(value * 100) / 100]
        }), (0, E.jsx)(`input`, {
          type: `number`,
          value: value,
          step: step,
    ...
    let o = () => {
      ...
      j(t, n, `鍒犻櫎鍑犱綍鍥惧舰`, e => ({
        ...e,
        shapes: e.shapes.filter(e => e.id !== target.id),
        editor: {
          ...e.editor,
          selectedShapeId: null
        }
    ...
    return (0, E.jsxs)(`div`, {
      ...
      children: [(0, E.jsxs)(`div`, {
        ...
        className: `panel-meta`,
        children: i.type === `rect` ? `鐭╁舰` : i.type === `circle` ? `鍦嗗舰` : i.type === `ellipse` ? `妞渾` : i.type === `line` ? `鐩寸嚎` : `澶氳竟褰
      }), i.type === `rect` && (0, E.jsxs)(E.Fragment, {
        children: [s(`X`, `x`, i.x), s(`Y`, `y`, i.y), s(`瀹絗, `width`, i.width), s(`楂榒, `height`, i.height), s(`鍦嗚`, `rx`, i.rx ?? 0)]
      }), i.type === `circle` && (0, E.jsxs)(E.Fragment, {
        children: [s(`涓績 X`, `cx`, i.cx), s(`涓績 Y`, `cy`, i.cy), s(`鍗婂緞`, `r`, i.r)]
      }), i.type === `ellipse` && (0, E.jsxs)(E.Fragment, {
        children: [s(`涓績 X`, `cx`, i.cx), s(`涓績 Y`, `cy`, i.cy), s(`X 鍗婂緞`, `rx`, i.rx), s(`Y 鍗婂緞`, `ry`, i.ry)]
      }), i.type === `line` && (0, E.jsxs)(E.Fragment, {
        children: [s(`X1`, `x1`, i.x1), s(`Y1`, `y1`, i.y1), s(`X2`, `x2`, i.x2), s(`Y2`, `y2`, i.y2)]
      }), i.type === `polygon` && (0, E.jsxs)(`label`, {
        className: `field`,
        children: [(0, E.jsx)(`span`, {
          children: `椤剁偣鍧愭爣`
        }), (0, E.jsx)(`input`, {
        ...
        className: `field`,
        children: [(0, E.jsx)(`span`, {
          children: [`濉厖閫忔槑搴? `, Math.round((i.fillOpacity ?? 1) * 100), `%`]
        }), (0, E.jsx)(`input`, {
          type: `range`,
          min: 0,
          max: 1,
          step: .05,
          value: i.fillOpacity ?? 1,
          onChange: e => ShapeUpdate(t, i.id, {
        ...
        className: `field`,
        children: [(0, E.jsx)(`span`, {
          children: [`鎻忚竟瀹藉害: `, i.strokeWidth, `px`]
        }), (0, E.jsx)(`input`, {
          type: `range`,
          min: 1,
          max: 10,
  ...
  ShapeSVG = e => {
    if (e.type === `rect`) return `<rect x="${e.x}" y="${e.y}" width="${e.width}" height="${e.height}" rx="${e.rx??0}" fill="${e.fill}" fill-opacity="${e.fillOpacity}" stroke="${e.stroke}" stroke-width="${e.strokeWidth}"/>`;
    if (e.type === `circle`) return `<circle cx="${e.cx}" cy="${e.cy}" r="${e.r}" fill="${e.fill}" fill-opacity="${e.fillOpacity}" stroke="${e.stroke}" stroke-width="${e.strokeWidth}"/>`;
    if (e.type === `ellipse`) return `<ellipse cx="${e.cx}" cy="${e.cy}" rx="${e.rx}" ry="${e.ry}" fill="${e.fill}" fill-opacity="${e.fillOpacity}" stroke="${e.stroke}" stroke-width="${e.strokeWidth}"/>`;
    if (e.type === `line`) return `<line x1="${e.x1}" y1="${e.y1}" x2="${e.x2}" y2="${e.y2}" stroke="${e.stroke}" stroke-width="${e.strokeWidth}"/>`;
    return `<polygon points="${e.points}" fill="${e.fill}" fill-opacity="${e.fillOpacity}" stroke="${e.stroke}" stroke-width="${e.strokeWidth}"/>`
  },
  mt = class {
    static exportSVG(e, t, n, r, i, a = [], u = []) {
      let o = [`<rect x="0" y="0" width="${n}" height="${r}" fill="#ffffff"/>`];
      i && o.push(`<g id="layer-map"><image href="${i}" x="0" y="0" width="${n}" height="${r}" preserveAspectRatio="none"/></g>`);
      let s = e.filter(e => e.visible && e.nodes.length >= 2).flatMap(e => {
        let t = T.generateSmoothPath(e.nodes),
          n = T.getStrokeStyle(e.style, e.width);
        if (e.style === `double`) return [`<path d="${t}" fill="none" stroke="${e.color}" stroke-width="${e.width+4}" stroke-linecap="round" stroke-linejoin="round"/>`, `<path d="${t}" fill="none" stroke="#ffffff" stroke-width="${Math.max(1.5,e.width*.45)}" stroke-linecap="round" stroke-linejoin="round"/>`];
        if (e.style === `dual-segment`) {
          let r = Math.max(1, e.segmentLength ?? 28),
            i = Math.max(0, e.segmentGap ?? 0),
            a = `${r} ${r+i}`,
            o = r + i,
            s = e.roundCap ? `round` : `butt`,
            c = e.segmentJoin ?? `round`;
          return [`<path d="${t}" fill="none" stroke="${e.color}" stroke-width="${n.strokeWidth}" stroke-linecap="${s}" stroke-linejoin="${c}" stroke-dasharray="${a}"/>`, `<path d="${t}" fill="none" stroke="${e.secondaryColor??`#ffffff`}" stroke-width="${n.strokeWidth}" stroke-linecap="${s}" stroke-linejoin="${c}" stroke-dasharray="${a}" stroke-dashoffset="${o}"/>`]
        }
        return [`<path d="${t}" fill="none" stroke="${e.color}" stroke-width="${n.strokeWidth}" stroke-linecap="round" stroke-linejoin="round"/>`]
      });
      o.push(`<g id="layer-railway">${s.join(``)}</g>`);
      let c = t.map(e => `<circle cx="${e.worldPos.x}" cy="${e.worldPos.y}" r="${e.radius}" fill="#ffffff" stroke="#111827" stroke-width="1.5"/>`);
      o.push(`<g id="layer-station">${c.join(``)}</g>`);
      let p = u.filter(e => e.visible).map(ShapeSVG);
      o.push(`<g id="layer-shape">${p.join(``)}</g>`);
      let l = a.filter(e => e.visible).map(e => `<text x="${e.worldPos.x}" y="${e.worldPos.y}" fill="${e.fill}" font-size="${e.fontSize}" font-family="${e.fontFamily}" text-anchor="${e.anchor}" transform="rotate(${e.rotation} ${e.worldPos.x} ${e.worldPos.y})">${ht(e.content)}</text>`);
      return o.push(`<g id="layer-text">${l.join(``)}</g>`), `<?xml version="1.0" encoding="UTF-8"?>
<svg xmlns="http://www.w3.org/2000/svg" width="${n}" height="${r}" viewBox="0 0 ${n} ${r}">
  ${o.join(`
  `)}
</svg>`
    }
    static downloadSVG(e, t = `railway-network.svg`) {
      let n = new Blob([e], {
          type: `image/svg+xml`
        }),
...
var gt = 1,
  _t = class e {
    static toProjectFile(e) {
      return {
        schema: `railway-editor-project`,
        version: gt,
        ...
        state: {
          ...
          texts: e.texts,
          shapes: e.shapes,
          mergeRelations: e.mergeRelations,
          mapImage: e.mapImage,
          mapImageSize: e.mapImageSize,
          layers: e.layers,
          snapConfig: e.snapConfig,
          animationCurrentTime: e.animationCurrentTime,
          animationTotalDuration: e.animationTotalDuration,
          animationCompletedIds: e.animationCompletedIds,
    ...
    static parse(e) {
      let t = JSON.parse(e);
      if (t.schema !== `railway-editor-project` || !t.state) throw Error(`鏂囦欢涓嶆槸鏈夋晥鐨勯搧璺紪杈戝櫒宸ョ▼鏂囦欢銆俙);
      return t.state.lines = t.state.lines?.map(e => ({
        ...e,
        style: String(e.style) === `rail-dash` ? `dual-segment` : e.style,
        secondaryColor: e.secondaryColor ?? `#ffffff`,
        segmentLength: e.segmentLength ?? 28,
        segmentGap: e.segmentGap ?? 0,
        roundCap: e.roundCap ?? !1,
        segmentJoin: e.segmentJoin ?? `round`,
        locked: e.locked ?? !1,
        extendDirection: e.extendDirection ?? `end`,
        nodes: e.nodes.map(e => ({
          ...e,
          pointType: e.pointType ?? `symmetric`
        }))
      })), t.state.stations = t.state.stations?.map(e => ({
        ...e,
        ...
        animationDelay: e.animationDelay ?? 120,
        animationDuration: e.animationDuration ?? 420,
        binding: e.binding ?? null
      })), t.state.texts = t.state.texts ?? [], t.state.shapes = t.state.shapes?.map(e => ({
        ...e,
        visible: e.visible ?? !0,
        locked: e.locked ?? !1,
        fillOpacity: e.fillOpacity ?? .18,
        strokeWidth: e.strokeWidth ?? 2
      })) ?? [], t.state.mergeRelations = t.state.mergeRelations ?? [], t.state.snapConfig = {
        ...t.state.snapConfig,
        handleSnap: t.state.snapConfig?.handleSnap ?? !0
      }, t.state.animationEasing = t.state.animationEasing ?? `linear`, t
    }
    static download(t, n = `railway-project.rejson`) {
      let r = JSON.stringify(e.toProjectFile(t), null, 2),
        i = new Blob([r], {
...
function vt({
  ...
  return (0, E.jsxs)(`svg`, {
    ...
    height: `16`,
    "aria-hidden": `true`,
    children: [e === `cursor` && (0, E.jsx)(`path`, {
      ...t,
      d: `M5 3l13 8-6 2-3 6z`
    }), e === `pen` && (0, E.jsx)(`path`, {
      ...t,
      d: `M4 20l4-1 10-10-3-3L5 16z M13 6l3-3 3 3-3 3`
    }), e === `station` && (0, E.jsxs)(E.Fragment, {
      children: [(0, E.jsx)(`circle`, {
        ...t,
        cx: `12`,
        cy: `12`,
      ...
      height: `14`,
      rx: `2`
    }), e === `circle` && (0, E.jsx)(`circle`, {
      ...t,
      cx: `12`,
      cy: `12`,
      r: `8`
    }), e === `ellipse` && (0, E.jsx)(`ellipse`, {
      ...t,
      cx: `12`,
      cy: `12`,
      rx: `9`,
      ry: `6`
    }), e === `triangle` && (0, E.jsx)(`path`, {
      ...t,
      d: `M12 4l8 16H4z`
    }), e === `line` && (0, E.jsx)(`path`, {
      ...t,
      ...
      ...t,
      d: `M8 12V6a2 2 0 0 1 4 0v5 M12 11V5a2 2 0 0 1 4 0v8 M16 13V8a2 2 0 0 1 4 0v6c0 4-3 7-7 7h-1c-3 0-5-2-6-5l-1-3a2 2 0 0 1 4-1z`
    }), e === `image` && (0, E.jsxs)(E.Fragment, {
      children: [(0, E.jsx)(`rect`, {
        ...t,
        x: `4`,
        y: `5`,
    ...
    }), e === `import` && (0, E.jsx)(`path`, {
      ...t,
      d: `M12 3v12 M8 11l4 4 4-4 M5 21h14`
    }), e === `export` && (0, E.jsx)(`path`, {
      ...t,
      d: `M12 15V3 M8 7l4-4 4 4 M5 21h14`
    }), e === `undo` && (0, E.jsx)(`path`, {
      ...t,
      d: `M9 7H4v5 M4 12a8 8 0 1 0 3-6`
    }), e === `redo` && (0, E.jsx)(`path`, {
      ...t,
      d: `M15 7h5v5 M20 12a8 8 0 1 1-3-6`
    }), e === `fit` && (0, E.jsx)(`path`, {
      ...t,
      d: `M5 9V5h4 M15 5h4v4 M19 15v4h-4 M9 19H5v-4`
    }), e === `grid` && (0, E.jsx)(`path`, {
      ...t,
      d: `M4 4h16v16H4z M4 10h16 M4 16h16 M10 4v16 M16 4v16`
    }), e === `node` && (0, E.jsxs)(E.Fragment, {
      children: [(0, E.jsx)(`circle`, {
        ...t,
        cx: `7`,
        cy: `12`,
...
var yt = ({
    ...
    let {
      ...
      let e = document.createElement(`input`);
      e.type = `file`, e.accept = `.rejson,application/json`, e.onchange = e => {
        let t = e.target.files?.[0];
        if (!t) return;
        let n = new FileReader;
        n.onload = e => {
          try {
            let t = _t.parse(String(e.target?.result ?? ``));
            r(e => ({
              ...e,
              ...t.state,
              isAnimationPlaying: !1,
            ...
            window.alert(e instanceof Error ? e.message : `宸ョ▼鏂囦欢瀵煎叆澶辫触銆俙)
          }
        }, n.readAsText(t)
      }, e.click()
    }, s = () => {
      mt.downloadSVG(mt.exportSVG(n.lines, n.stations, n.canvasSize.width, n.canvasSize.height, n.mapImage, n.texts, n.shapes))
    }, c = () => {
      r(e => ({
        ...e,
        layers: e.layers.map(e => e.type === `grid` ? {
          ...e,
          visible: !e.visible
        } : e)
      }))
      ...
      label: `骞崇Щ`,
      icon: `hand`
    }], u = i.current?.canUndo() ?? !1, d = i.current?.canRedo() ?? !1, f = n.layers.find(e => e.type === `grid`)?.visible ?? !0;
    return (0, E.jsxs)(`div`, {
      className: `toolbar`,
      children: [(0, E.jsx)(`div`, {
        className: `brand`,
        ...
        children: l.map(e => (0, E.jsxs)(`button`, {
          className: `toolbar-button ${n.editor.activeTool===e.id?`active`:``}`,
          title: e.label,
          onClick: () => de(r, e.id),
          children: [(0, E.jsx)(vt, {
            name: e.icon
        ...
        children: [(0, E.jsxs)(`button`, {
          ...
          children: [Math.round(n.transform.scale * 100), `%`]
        })]
      }), (0, E.jsx)(`div`, {
        className: `toolbar-separator`
      }), (0, E.jsxs)(`div`, {
        className: `toolbar-group`,
        children: [(0, E.jsxs)(`button`, {
          className: `toolbar-button ${f?`active`:``}`,
          onClick: c,
          title: `鏄剧ず/闅愯棌缃戞牸 (G)`,
          children: [(0, E.jsx)(vt, {
            name: `grid`
          ...
          className: `grid-size-control`,
          title: `缃戞牸澶у皬`,
          children: [(0, E.jsxs)(`span`, {
            children: [n.snapConfig.gridSize, `px`]
          }), (0, E.jsx)(`input`, {
            type: `range`,
            min: 10,
            max: 100,
            step: 5,
            value: n.snapConfig.gridSize,
            onChange: e => ye(r, {
              gridSize: Number(e.target.value)
            })
          })]
        }), (0, E.jsxs)(`button`, {
          className: `toolbar-button ${n.snapConfig.nodeSnap?`active-green`:``}`,
          onClick: () => ye(r, {
            nodeSnap: !n.snapConfig.nodeSnap
          }),
          title: `鑺傜偣鍚搁檮鍒扮綉鏍间氦鐐筦,
          children: [(0, E.jsx)(vt, {
            name: `node`
          }), (0, E.jsx)(`span`, {
            children: `鑺傜偣鍚搁檮`
          ...
          className: `toolbar-button ${n.snapConfig.handleSnap?`active-green`:``}`,
          onClick: () => ye(r, {
            handleSnap: !n.snapConfig.handleSnap
          }),
          title: `閿氱偣鍚搁檮鍒扮綉鏍间氦鐐筦,
          children: [(0, E.jsx)(vt, {
            name: `handle`
          }), (0, E.jsx)(`span`, {
            children: `閿氱偣鍚搁檮`
        ...
        title: `鍥句緥瀛楀彿`,
        children: [(0, E.jsxs)(`span`, {
          children: [`鍥句緥 `, n.ui.legendFontSize, `px`]
        }), (0, E.jsx)(`input`, {
          type: `range`,
          min: 9,
          max: 24,
          step: 1,
          value: n.ui.legendFontSize,
          onChange: e => Ce(r, {
            legendFontSize: Number(e.target.value)
          })
        })]
      }), (0, E.jsxs)(`label`, {
        className: `font-size-control`,
        title: `绔欑偣瀛楀彿`,
        children: [(0, E.jsxs)(`span`, {
          children: [`绔欑偣 `, n.ui.stationFontSize, `px`]
        }), (0, E.jsx)(`input`, {
          type: `range`,
          min: 9,
          max: 30,
          step: 1,
          value: n.ui.stationFontSize,
          onChange: e => Ce(r, {
            stationFontSize: Number(e.target.value)
          })
        })]
      })]
    })
  ...
  bt = () => {
    let e = (0, C.useRef)(null),
      ...
      [a, o] = (0, C.useState)(() => !localStorage.getItem(`railway-toast-v2`)),
      s = (0, C.useCallback)(() => {
        o(!1), localStorage.setItem(`railway-toast-v2`, `1`)
      }, []),
      c = (0, C.useRef)(null),
      l = (0, C.useRef)(null),
      u = (0, C.useRef)(!1),
    ...
    let {
      ...
      handleCanvasClick: ee,
      finishDrawing: te
    } = Ie(S), {
      handleNodeMouseDown: ne,
      handleNodeDrag: re,
      handleNodeMouseUp: ie
    } = Re(S), ae = (0, C.useCallback)(t => {
    ...
    }, []), oe = (0, C.useCallback)((e, t, i) => {
      let a = n.lines.find(e => e.id === t),
        o = a?.nodes.find(e => e.id === i);
      if (!(!a || !o)) {
        A(r, {
          selectedLineId: t,
          selectedNodeId: i
        });
        for (let e of n.lines)
          if (!(e.id === t || !e.visible)) {
            for (let r of e.nodes)
              if (we(a, i, e, r.id)) {
                if (Te(n, t, i, e.id, r.id)) return;
                p({
                  lineIdA: t,
                  nodeIdA: i,
                  lineIdB: e.id,
    ...
    }, [r, n]), se = (0, C.useCallback)(() => {
      f && (Oe(r, f.lineIdA, f.nodeIdA, f.lineIdB, f.nodeIdB), p(null))
    }, [f, r]), ce = (0, C.useCallback)(() => {
      p(null)
    }, []), D = (0, C.useCallback)((e, t) => {
      let i = S(e, t),
        a = M.screenLengthToWorld(10, w);
      for (let e of [...n.lines].reverse())
        if (!(!e.visible || e.nodes.length < 2) && T.pointToPolylineDistance(i, e.nodes) <= a) return A(r, {
          selectedLineId: e.id,
          selectedNodeId: null,
          selectedStationId: null,
          selectedTextId: null
    ...
    }, [S, r, n.lines, w]), O = (0, C.useCallback)(e => {
      let t = T.findNearestLineProjection(e, n.lines.filter(e => !e.locked)),
        r = M.screenLengthToWorld(28, w),
        i = !!(t && t.distance <= r);
      return {
        id: x(),
        worldPos: i && t ? t.point : e,
        name: `Station ${n.stations.length+1}`,
        lineIds: i && t ? [t.lineId] : [],
        radius: 8,
        fill: `#ffffff`,
        stroke: `#111827`,
        labelVisible: !0,
        ...
        bindingMode: i && t ? t.lineId : `none`,
        binding: i && t ? {
          lineId: t.lineId,
          t: t.t
        } : null
      }
    }, [n.lines, n.stations.length, w]), le = (0, C.useCallback)(e => ({
      id: x(),
      worldPos: e,
      content: `Text`,
      fontSize: 18,
      fontFamily: n.ui.fontFamily,
      fill: `#111827`,
      anchor: `middle`,
      rotation: 0,
      visible: !0
    }), [n.ui.fontFamily]), ue = (0, C.useCallback)(e => {
      if (d.current) {
        d.current = !1;
        return
      }
      ...
      if (n.editor.activeTool === `pan`) return;
      let t = ae(e);
      if (n.editor.activeTool === `select`) {
        D(t.x, t.y);
        return
      }
      if (n.editor.activeTool === `draw-line`) {
        ee(t.x, t.y);
        return
      }
      if (n.editor.activeTool?.startsWith(`shape-`)) {
        let e = ShapeCreate(n.editor.activeTool, S(t.x, t.y));
        j(r, i, `娣诲姞鍑犱綍鍥惧舰`, t => ({
          ...t,
          shapes: [...t.shapes, e]
        }), t => ({
          ...t,
          shapes: t.shapes.filter(t => t.id !== e.id)
        })), A(r, {
      ...
      if (n.editor.activeTool === `add-station`) {
        let e = O(S(t.x, t.y));
        j(r, i, `Add station`, t => ({
          ...t,
          stations: [...t.stations, e]
          ...
          selectedStationId: e.id,
          selectedLineId: null,
          selectedNodeId: null
        });
        return
      }
      if (n.editor.activeTool === `add-text`) {
        let e = le(S(t.x, t.y));
        j(r, i, `Add text`, t => ({
          ...t,
          texts: [...t.texts, e]
    ...
    }, [O, le, i, ae, ee, S, D, r, n.editor.activeTool]), de = (0, C.useCallback)((e, t) => {
      e.stopPropagation();
      let i = n.stations.find(e => e.id === t);
      i && (c.current = {
        stationId: t,
        before: {
          ...i,
        ...
        selectedNodeId: null,
        selectedTextId: null,
        dragMode: `dragging-station`
      }))
    }, [r, n.stations]), pe = (0, C.useCallback)((e, t) => {
      e.stopPropagation();
      let i = n.texts.find(e => e.id === t);
      i && (l.current = {
        textId: t,
        before: {
          ...i,
        ...
        selectedNodeId: null,
        selectedStationId: null,
        dragMode: `dragging-text`
      }))
    }, [r, n.texts]), me = (0, C.useCallback)((e, t) => {
      e.stopPropagation();
      let i = n.shapes.find(e => e.id === t);
      if (!i) return;
      let a = ae(e);
      qs.current = {
        id: t,
      ...
      A(r, {
        ...
        selectedStationId: null,
        selectedTextId: null,
        dragMode: `dragging-shape`
      })
    }, [r, n.shapes, S, ae]), he = (0, C.useCallback)(e => {
      _(e);
      let t = ae(e);
      if (re(t.x, t.y), c.current) {
        let e = S(t.x, t.y),
          i = M.screenLengthToWorld(28, w),
          a = T.findNearestLineProjection(e, n.lines.filter(e => !e.locked));
        a && a.distance <= i ? be(r, c.current.stationId, {
          worldPos: a.point,
          lineIds: [a.lineId],
          bindingMode: a.lineId,
          binding: {
            lineId: a.lineId,
            t: a.t
          }
        }) : be(r, c.current.stationId, {
          worldPos: e,
          lineIds: [],
          bindingMode: `none`,
          binding: null
      ...
      if (l.current) {
        ...
        r(t => ({
          ...t,
          texts: t.texts.map(t => t.id === l.current?.textId ? {
            ...t,
            worldPos: e
          } : t)
        }))
      ...
      if (qs.current) {
        let e = S(t.x, t.y),
          i = qs.current.before,
          a = e.x - qs.current.start.x,
          o = e.y - qs.current.start.y,
          s = ShapeMove(i, a, o);
        r(t => ({
          ...t,
          shapes: t.shapes.map(t => t.id === qs.current.id ? s : t)
        }))
      }
    }, [ae, re, S, r, n.lines, w, _]), ge = (0, C.useCallback)(() => {
      v(), u.current = ie();
      let e = c.current;
      c.current = null;
      let t = l.current;
      if (l.current = null, A(r, {
          dragMode: `idle`
        }), e) {
        let t = n.stations.find(t => t.id === e.stationId);
        if (t && Math.hypot(t.worldPos.x - e.before.worldPos.x, t.worldPos.y - e.before.worldPos.y) > .1) {
          d.current = !0;
          let n = {
            ...t,
            lineIds: [...t.lineIds],
          ...
          j(r, i, `Move station`, t => ({
            ...t,
            stations: t.stations.map(t => t.id === e.stationId ? n : t)
          }), t => ({
            ...t,
            stations: t.stations.map(t => t.id === e.stationId ? e.before : t)
          }))
        }
      }
      if (t) {
        let e = n.texts.find(e => e.id === t.textId);
        if (e && Math.hypot(e.worldPos.x - t.before.worldPos.x, e.worldPos.y - t.before.worldPos.y) > .1) {
          d.current = !0;
          let n = {
            ...e
          };
          j(r, i, `Move text`, e => ({
            ...e,
            texts: e.texts.map(e => e.id === t.textId ? n : e)
          }), e => ({
            ...e,
            texts: e.texts.map(e => e.id === t.textId ? t.before : e)
          }))
        }
      }
      if (qs.current) {
        let e = qs.current;
        qs.current = null;
        let t = n.shapes.find(t => t.id === e.id);
        if (t && JSON.stringify(t) !== JSON.stringify(e.before)) {
          let after = {
            ...t
          };
          j(r, i, `绉诲姩鍑犱綍鍥惧舰`, t => ({
            ...t,
            shapes: t.shapes.map(t => t.id === e.id ? after : t)
          }), t => ({
            ...t,
            shapes: t.shapes.map(t => t.id === e.id ? e.before : t)
          }))
        }
      }
    }, [i, ie, r, n.stations, n.texts, n.shapes, v]);
    (0, C.useEffect)(() => {
      let e = e => {
        let t = e.target;
        if (!(t instanceof HTMLInputElement || t instanceof HTMLTextAreaElement || t instanceof HTMLSelectElement || t?.isContentEditable)) {
          if (e.key === `Escape` && (te(), A(r, {
              selectedLineId: null,
              selectedNodeId: null,
              selectedStationId: null,
              selectedTextId: null,
              selectedShapeId: null
            })), (e.ctrlKey || e.metaKey) && e.key.toLowerCase() === `z` && (e.preventDefault(), i.current.undo()), (e.ctrlKey || e.metaKey) && e.key.toLowerCase() === `y` && (e.preventDefault(), i.current.redo()), e.key.toLowerCase() === `g` && !e.ctrlKey && !e.metaKey && r(e => ({
              ...e,
              layers: e.layers.map(e => e.type === `grid` ? {
                ...e,
                visible: !e.visible
              } : e)
            })), (e.key === `Delete` || e.key === `Backspace`) && n.editor.selectedLineId) {
            let e = n.lines.find(e => e.id === n.editor.selectedLineId);
            if (e?.locked) return;
            if (n.editor.selectedNodeId) {
              let t = n.editor.selectedLineId,
                a = n.editor.selectedNodeId,
                o = e?.nodes.find(e => e.id === a),
                s = e?.nodes.findIndex(e => e.id === a) ?? -1;
              o && s >= 0 ? j(r, i, `Delete node`, e => ({
                ...e,
                lines: e.lines.map(e => e.id === t ? {
                  ...e,
                  nodes: e.nodes.filter(e => e.id !== a)
                } : e)
              }), e => ({
                ...e,
                lines: e.lines.map(e => e.id === t ? {
                  ...e,
                  nodes: [...e.nodes.slice(0, s), o, ...e.nodes.slice(s)]
                } : e)
              })) : me(r, n.editor.selectedLineId, n.editor.selectedNodeId), A(r, {
                selectedNodeId: null
              })
            } else e ? (j(r, i, `Delete line`, t => ({
              ...t,
              lines: t.lines.filter(t => t.id !== e.id)
            }), t => ({
              ...t,
              ...
              selectedLineId: null
            })) : (fe(r, n.editor.selectedLineId), A(r, {
              selectedLineId: null
            }))
          }
          if ((e.key === `Delete` || e.key === `Backspace`) && n.editor.selectedStationId) {
            let e = n.stations.find(e => e.id === n.editor.selectedStationId);
            if (!e) return;
            j(r, i, `Delete station`, t => ({
              ...t,
              stations: t.stations.filter(t => t.id !== e.id),
              editor: {
                ...t.editor,
          ...
          if ((e.key === `Delete` || e.key === `Backspace`) && n.editor.selectedTextId) {
            let e = n.texts.find(e => e.id === n.editor.selectedTextId);
            if (!e) return;
            j(r, i, `Delete text`, t => ({
              ...t,
              texts: t.texts.filter(t => t.id !== e.id),
          ...
          if ((e.key === `Delete` || e.key === `Backspace`) && n.editor.selectedShapeId) {
            let e = n.shapes.find(e => e.id === n.editor.selectedShapeId);
            if (!e) return;
            j(r, i, `Delete shape`, t => ({
              ...t,
              shapes: t.shapes.filter(t => t.id !== e.id),
              editor: {
                ...t.editor,
    ...
    }, [i, te, r, n.editor.selectedLineId, n.editor.selectedNodeId, n.editor.selectedStationId, n.editor.selectedTextId, n.editor.selectedShapeId, n.lines, n.stations, n.texts, n.shapes]);
    let _e = n.layers.find(e => e.type === `map`)?.visible,
      ve = n.layers.find(e => e.type === `grid`)?.visible,
      ye = n.layers.find(e => e.type === `railway`)?.visible,
      xe = n.layers.find(e => e.type === `station`)?.visible,
      Se = n.layers.find(e => e.type === `edit-assist`)?.visible,
      Ce = n.layers.find(e => e.type === `grid`)?.opacity ?? .3,
      Ee = n.editor.activeTool === `pan` ? `grab` : n.editor.activeTool === `draw-line` || n.editor.activeTool === `add-station` || n.editor.activeTool === `add-text` || n.editor.activeTool?.startsWith(`shape-`) ? `crosshair` : `default`;
    return (0, E.jsxs)(`div`, {
      className: `app-shell`,
      style: {
        "--legend-font-size": `${n.ui.legendFontSize}px`,
        "--editor-font-family": n.ui.fontFamily
      },
      children: [(0, E.jsx)(yt, {
        onZoomFit: y,
        onZoomReset: b
        ...
        children: [(0, E.jsxs)(`svg`, {
          ...
          children: [(0, E.jsx)(`rect`, {
            ...
            transform: M.getTransformString(w),
            children: [_e && (0, E.jsx)(Je, {}), ve && (0, E.jsx)(Ue, {
              gridSize: n.snapConfig.gridSize,
              opacity: Ce
            }), ye && (0, E.jsx)(tt, {
              onNodeMouseDown: ne,
              onNodeClick: oe,
              selectedLineId: n.editor.selectedLineId,
              selectedNodeId: n.editor.selectedNodeId
            }), xe && (0, E.jsx)(it, {
              onStationMouseDown: de
            }), (0, E.jsx)(ct, {
              onTextMouseDown: pe
            }), (0, E.jsx)(ShapeLayer, {
              onShapeMouseDown: me
        ...
        }), n.editor.selectedLineId && (0, E.jsx)(qe, {}), n.editor.selectedStationId && (0, E.jsx)(ot, {}), n.editor.selectedTextId && (0, E.jsx)(pt, {}), n.editor.selectedShapeId && (0, E.jsx)(ShapePanel, {}), (0, E.jsx)(Ke, {}), (0, E.jsx)(Ve, {}), f && (0, E.jsxs)(`div`, {
          className: `merge-tooltip`,
          children: [(0, E.jsx)(`span`, {
            children: `妫€娴嬪埌閲嶅悎鑺傜偣锛屾槸鍚﹀缓绔嬪苟绾垮叧绯伙紵`
          }), (0, E.jsx)(`button`, {
        ...
        }), (0, E.jsx)(We, {}), (0, E.jsx)(st, {
          transform: w
        })]
      }), a && (0, E.jsxs)(`div`, {
        className: `welcome-toast`,
        children: [(0, E.jsx)(`div`, {
          className: `welcome-toast-text`,
          children: `鏈郴缁熺敤浜庡揩鎹峰埗浣滅嚎缃戝姩鐢伙紝鏇村姞閫傞厤浜庡鍏ュ湴鍥惧悗锛屾牴鎹湴鍥惧埗浣滄湭缁忓嚑浣曞彉褰㈢嚎缃戙€傜洰鍓嶅彲浣跨敤褰曞睆鏉ヨ幏鍙栧姩鐢昏棰戙€俙
        }), (0, E.jsx)(`button`, {
...
w.createRoot(document.getElementById(`root`)).render((0, E.jsx)(C.StrictMode, {
  children: (0, E.jsx)(xt, {})
}));
